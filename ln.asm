 ...
 641:	a1 e0 0a 00 00       	mov    0xae0,%eax
{
 ...
 67d:	89 08                	mov    %ecx,(%eax)
	freep = p;
 67f:	a3 e0 0a 00 00       	mov    %eax,0xae0
}
 684:	5b                   	pop    %ebx
 685:	5e                   	pop    %esi
 686:	5f                   	pop    %edi
 ...
 696:	72 ce                	jb     666 <free+0x26>
{
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
	freep = p;
 6ba:	a3 e0 0a 00 00       	mov    %eax,0xae0
		p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 774:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
 777:	89 15 e0 0a 00 00    	mov    %edx,0xae0
}
 ...
 789:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		base.s.ptr = freep = prevp = &base;
 790:	c7 05 e0 0a 00 00 e4 	movl   $0xae4,0xae0
 797:	0a 00 00 
 79a:	c7 05 e4 0a 00 00 e4 	movl   $0xae4,0xae4
 7a1:	0a 00 00 
		base.s.size                = 0;
 7a4:	b8 e4 0a 00 00       	mov    $0xae4,%eax
 7a9:	c7 05 e8 0a 00 00 00 	movl   $0x0,0xae8
 7b0:	00 00 00 
