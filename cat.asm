...
shm_get(char* name)
{
 ...
 363:	5d                   	pop    %ebp
	return shmget(name);
 364:	e9 b8 00 00 00       	jmp    421 <shmget>
...
shm_rem(char* name)
{
 ...
 373:	5d                   	pop    %ebp
	return shmrem(name);
 374:	e9 b0 00 00 00       	jmp    429 <shmrem>
...
free(void *ap)
{
 ...
 6b1:	a1 a0 0b 00 00       	mov    0xba0,%eax
{
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
	freep = p;
 6ef:	a3 a0 0b 00 00       	mov    %eax,0xba0
}
 6f4:	5b                   	pop    %ebx
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
 ...
 706:	72 ce                	jb     6d6 <free+0x26>
{
 ...
 727:	03 53 fc             	add    -0x4(%ebx),%edx
	freep = p;
 72a:	a3 a0 0b 00 00       	mov    %eax,0xba0
		p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
	if ((prevp = freep) == 0) {
 74c:	8b 15 a0 0b 00 00    	mov    0xba0,%edx
	nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 78f:	73 47                	jae    7d8 <malloc+0x98>
		...
		if (p == freep)
 791:	39 05 a0 0b 00 00    	cmp    %eax,0xba0
 ...
 7b6:	e8 f5 fe ff ff       	call   6b0 <free>
	return freep;
 7bb:	8b 15 a0 0b 00 00    	mov    0xba0,%edx
 ...
 7e4:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
 7e7:	89 15 a0 0b 00 00    	mov    %edx,0xba0
}
 ...
 7f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		base.s.ptr = freep = prevp = &base;
 800:	c7 05 a0 0b 00 00 a4 	movl   $0xba4,0xba0
 807:	0b 00 00 
 80a:	c7 05 a4 0b 00 00 a4 	movl   $0xba4,0xba4
 811:	0b 00 00 
		base.s.size                = 0;
 814:	b8 a4 0b 00 00       	mov    $0xba4,%eax
 819:	c7 05 a8 0b 00 00 00 	movl   $0x0,0xba8
 820:	00 00 00 
