  ...
  21:	83 f8 01             	cmp    $0x1,%eax
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	pushl  (%ebx)
  37:	e8 85 03 00 00       	call   3c1 <open>
  ...
  57:	e8 4d 03 00 00       	call   3a9 <close>
	for (i = 1; i < argc; i++) {
  ...
  62:	75 cc                	jne    30 <main+0x30>
	...
	exit();
  64:	e8 18 03 00 00       	call   381 <exit>
			printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	pushl  (%ebx)
  ...
  73:	e8 a8 04 00 00       	call   520 <printf>
			exit();
  78:	e8 04 03 00 00       	call   381 <exit>
		cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
		exit();
  87:	e8 f5 02 00 00       	call   381 <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 f1 02 00 00       	call   3a1 <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 cf 02 00 00       	call   399 <read>
  ...
  fa:	e8 21 04 00 00       	call   520 <printf>
		exit();
  ff:	e8 7d 02 00 00       	call   381 <exit>
 ...
 228:	89 f3                	mov    %esi,%ebx
{
 ...
 240:	50                   	push   %eax
 241:	6a 00                	push   $0x0
 243:	e8 51 01 00 00       	call   399 <read>
		if (cc < 1) break;
...
stat(char *n, struct stat *st)
{
 ...
 2ad:	e8 0f 01 00 00       	call   3c1 <open>
	if (fd < 0) return -1;
 ...
 2c1:	50                   	push   %eax
 2c2:	e8 12 01 00 00       	call   3d9 <fstat>
	close(fd);
 2c7:	89 1c 24             	mov    %ebx,(%esp)
	r = fstat(fd, st);
 2ca:	89 c6                	mov    %eax,%esi
	close(fd);
 2cc:	e8 d8 00 00 00       	call   3a9 <close>
	return r;
...
shm_get(char* name)
{
 ...
 363:	5d                   	pop    %ebp
	return shmget(name);
 364:	e9 00 01 00 00       	jmp    469 <shmget>
...
shm_rem(char* name)
{
 ...
 373:	5d                   	pop    %ebp
	return shmrem(name);
 374:	e9 f8 00 00 00       	jmp    471 <shmrem>
...
00000461 <testpqdq>:
SYSCALL(testpqdq)
 461:	b8 1e 00 00 00       	mov    $0x1e,%eax
 466:	cd 40                	int    $0x40
 468:	c3                   	ret    

00000469 <shmget>:
SYSCALL(shmget)
 469:	b8 1f 00 00 00       	mov    $0x1f,%eax
 46e:	cd 40                	int    $0x40
 470:	c3                   	ret    

00000471 <shmrem>:
 471:	b8 20 00 00 00       	mov    $0x20,%eax
 476:	cd 40                	int    $0x40
 478:	c3                   	ret    
 ...
 489:	85 d2                	test   %edx,%edx
{
 ...
 4f0:	e8 ac fe ff ff       	call   3a1 <write>
...
printf(int fd, char *fmt, ...)
{
 ...
 560:	e8 3c fe ff ff       	call   3a1 <write>
 ...
 5c1:	e8 db fd ff ff       	call   3a1 <write>
 ...
 5d8:	31 ff                	xor    %edi,%edi
	write(fd, &c, 1);
 5da:	e8 c2 fd ff ff       	call   3a1 <write>
	for (i = 0; fmt[i]; i++) {
 ...
 673:	57                   	push   %edi
 674:	53                   	push   %ebx
 675:	e8 27 fd ff ff       	call   3a1 <write>
				while (*s != 0) {
 ...
 6c7:	e8 d5 fc ff ff       	call   3a1 <write>
				ap++;
...
free(void *ap)
{
 ...
 6f1:	a1 e0 0b 00 00       	mov    0xbe0,%eax
{
 ...
 72d:	89 08                	mov    %ecx,(%eax)
	freep = p;
 72f:	a3 e0 0b 00 00       	mov    %eax,0xbe0
}
 734:	5b                   	pop    %ebx
 735:	5e                   	pop    %esi
 736:	5f                   	pop    %edi
 ...
 746:	72 ce                	jb     716 <free+0x26>
{
 ...
 767:	03 53 fc             	add    -0x4(%ebx),%edx
	freep = p;
 76a:	a3 e0 0b 00 00       	mov    %eax,0xbe0
		p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
	if ((prevp = freep) == 0) {
 78c:	8b 15 e0 0b 00 00    	mov    0xbe0,%edx
	nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 7de:	56                   	push   %esi
 7df:	e8 25 fc ff ff       	call   409 <sbrk>
 ...
 824:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
 827:	89 15 e0 0b 00 00    	mov    %edx,0xbe0
}
 ...
 839:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		base.s.ptr = freep = prevp = &base;
 840:	c7 05 e0 0b 00 00 e4 	movl   $0xbe4,0xbe0
 847:	0b 00 00 
 84a:	c7 05 e4 0b 00 00 e4 	movl   $0xbe4,0xbe4
 851:	0b 00 00 
		base.s.size                = 0;
 854:	b8 e4 0b 00 00       	mov    $0xbe4,%eax
 859:	c7 05 e8 0b 00 00 00 	movl   $0x0,0xbe8
 860:	00 00 00 
