...
main(int argc, char *argv[])
{
  ...
  59:	83 c4 10             	add    $0x10,%esp
	exit();
  5c:	e8 80 02 00 00       	call   2e1 <exit>
  61:	66 90                	xchg   %ax,%ax
  63:	66 90                	xchg   %ax,%ax
  65:	66 90                	xchg   %ax,%ax
  67:	66 90                	xchg   %ax,%ax
 ...
 611:	a1 94 0a 00 00       	mov    0xa94,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
	freep = p;
 64f:	a3 94 0a 00 00       	mov    %eax,0xa94
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
 747:	89 15 94 0a 00 00    	mov    %edx,0xa94
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		base.s.ptr = freep = prevp = &base;
 760:	c7 05 94 0a 00 00 98 	movl   $0xa98,0xa94
 767:	0a 00 00 
 76a:	c7 05 98 0a 00 00 98 	movl   $0xa98,0xa98
 771:	0a 00 00 
		base.s.size                = 0;
 774:	b8 98 0a 00 00       	mov    $0xa98,%eax
