...
00000120 <iputtest>:
{
	...
	printf(stdout, "iput test\n");
     ...
     12b:	ff 35 68 5e 00 00    	pushl  0x5e68
	...
	printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     1a8:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     1bf:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     1d6:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     1ed:	ff 35 68 5e 00 00    	pushl  0x5e68
...
00000200 <exitiputtest>:
{
	...
	printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 68 5e 00 00    	pushl  0x5e68
	...
	printf(stdout, "exitiput test ok\n");
     ...
     27d:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     298:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     2af:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     2c6:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     2dd:	ff 35 68 5e 00 00    	pushl  0x5e68
...
000002f0 <openiputtest>:
{
	...
	printf(stdout, "openiput test\n");
     ...
     2fb:	ff 35 68 5e 00 00    	pushl  0x5e68
	...
	if (pid == 0) {
     ...
     34a:	ff 35 68 5e 00 00    	pushl  0x5e68
	...
	printf(stdout, "openiput test ok\n");
     ...
     38a:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     3ac:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     3c3:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     3da:	ff 35 68 5e 00 00    	pushl  0x5e68
...
000003f0 <opentest>:
{
	...
	printf(stdout, "open test\n");
     ...
     3fb:	ff 35 68 5e 00 00    	pushl  0x5e68
	...
	printf(stdout, "open test ok\n");
     ...
     441:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     458:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     46f:	ff 35 68 5e 00 00    	pushl  0x5e68
...
00000480 <writetest>:
{
	...
	printf(stdout, "small file test\n");
     ...
     48d:	ff 35 68 5e 00 00    	pushl  0x5e68
	...
	for (i = 0; i < 100; i++) {
     ...
     4c0:	ff 35 68 5e 00 00    	pushl  0x5e68
	...
	printf(stdout, "writes ok\n");
     ...
     518:	ff 35 68 5e 00 00    	pushl  0x5e68
	...
	if (fd >= 0) {
     ...
     54e:	ff 35 68 5e 00 00    	pushl  0x5e68
	...
	if (i == 2000) {
     ...
     582:	ff 35 68 5e 00 00    	pushl  0x5e68
	...
	printf(stdout, "small file test ok\n");
     ...
     5b0:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     5ce:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     5e7:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     5fe:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     615:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     62c:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     643:	ff 35 68 5e 00 00    	pushl  0x5e68
...
00000660 <writetest1>:
{
	...
	printf(stdout, "big files test\n");
     ...
     66d:	ff 35 68 5e 00 00    	pushl  0x5e68
	...
	printf(stdout, "big files ok\n");
     ...
     765:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     783:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     79a:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     7b3:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     7ce:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     7e5:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     7fc:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     813:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     834:	bb 30 00 00 00       	mov    $0x30,%ebx
{
	...
	printf(stdout, "many creates, followed by unlink test\n");
     ...
     841:	ff 35 68 5e 00 00    	pushl  0x5e68
	...
	printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8c6:	ff 35 68 5e 00 00    	pushl  0x5e68
...
000008e0 <dirtest>:
{
	...
	printf(stdout, "mkdir test\n");
     ...
     8eb:	ff 35 68 5e 00 00    	pushl  0x5e68
	...
	printf(stdout, "mkdir test ok\n");
     ...
     951:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     968:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     97f:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     996:	ff 35 68 5e 00 00    	pushl  0x5e68
     ...
     9ad:	ff 35 68 5e 00 00    	pushl  0x5e68
...
000009c0 <exectest>:
{
	...
	printf(stdout, "exec test\n");
     ...
     9cb:	ff 35 68 5e 00 00    	pushl  0x5e68
     9d1:	e8 4a 30 00 00       	call   3a20 <printf>
	if (exec("echo", echoargv) < 0) {
     9d6:	5a                   	pop    %edx
     9d7:	59                   	pop    %ecx
     9d8:	68 6c 5e 00 00       	push   $0x5e6c
     ...
     9f7:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    2d36:	31 ff                	xor    %edi,%edi
{
    ...
    2d40:	ff 35 68 5e 00 00    	pushl  0x5e68
	...
	*lastaddr = 99;
    ...
    2fd3:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    2ff4:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    3027:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    3054:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    3073:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    308a:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    30a1:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    30b8:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    30cf:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    30e6:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    30fd:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    3119:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    3130:	ff 35 68 5e 00 00    	pushl  0x5e68
...
00003150 <validatetest>:
{
    ...
    315f:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    31c9:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    31eb:	ff 35 68 5e 00 00    	pushl  0x5e68
...
00003200 <bsstest>:
{
    ...
    320b:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    324b:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    3263:	ff 35 68 5e 00 00    	pushl  0x5e68
...
00003280 <bigargtest>:
{
    ...
    32f7:	ff 35 68 5e 00 00    	pushl  0x5e68
		args[MAXARG - 1] = 0;
    ...
    3324:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    3354:	ff 35 68 5e 00 00    	pushl  0x5e68
    ...
    336b:	ff 35 68 5e 00 00    	pushl  0x5e68
...
00003630 <rand>:
    ...
    3630:	69 05 64 5e 00 00 0d 	imul   $0x19660d,0x5e64,%eax
    3637:	66 19 00 
{
    363a:	55                   	push   %ebp
    ...
    3643:	a3 64 5e 00 00       	mov    %eax,0x5e64
}
    3648:	c3                   	ret    
...
shm_get(char* name)
{
    ...
    38a3:	5d                   	pop    %ebp
	return shmget(name);
    38a4:	e9 b8 00 00 00       	jmp    3961 <shmget>
...
shm_rem(char* name)
{
    ...
    38b3:	5d                   	pop    %ebp
	return shmrem(name);
    38b4:	e9 b0 00 00 00       	jmp    3969 <shmrem>
    ...
    3989:	85 d2                	test   %edx,%edx
{
    ...
    39f0:	e8 ec fe ff ff       	call   38e1 <write>
...
printf(int fd, char *fmt, ...)
{
    ...
    3a60:	e8 7c fe ff ff       	call   38e1 <write>
    ...
    3ac1:	e8 1b fe ff ff       	call   38e1 <write>
    ...
    3b73:	57                   	push   %edi
    3b74:	53                   	push   %ebx
    3b75:	e8 67 fd ff ff       	call   38e1 <write>
				while (*s != 0) {
    ...
    3bc7:	e8 15 fd ff ff       	call   38e1 <write>
				ap++;
...
free(void *ap)
{
    ...
    3bf1:	a1 00 5f 00 00       	mov    0x5f00,%eax
{
	...
	freep = p;
    3c2f:	a3 00 5f 00 00       	mov    %eax,0x5f00
}
    3c34:	5b                   	pop    %ebx
    3c35:	5e                   	pop    %esi
    3c36:	5f                   	pop    %edi
    ...
    3c46:	72 ce                	jb     3c16 <free+0x26>
{
	...
	freep = p;
    3c6a:	a3 00 5f 00 00       	mov    %eax,0x5f00
		p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
	...
	if ((prevp = freep) == 0) {
    3c8c:	8b 15 00 5f 00 00    	mov    0x5f00,%edx
	nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
	...
	return freep;
    3cfb:	8b 15 00 5f 00 00    	mov    0x5f00,%edx
    ...
    3d24:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
    3d27:	89 15 00 5f 00 00    	mov    %edx,0x5f00
}
    ...
    3d39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		base.s.ptr = freep = prevp = &base;
    3d40:	c7 05 00 5f 00 00 04 	movl   $0x5f04,0x5f00
    3d47:	5f 00 00 
    3d4a:	c7 05 04 5f 00 00 04 	movl   $0x5f04,0x5f04
    3d51:	5f 00 00 
		base.s.size                = 0;
    3d54:	b8 04 5f 00 00       	mov    $0x5f04,%eax
    3d59:	c7 05 08 5f 00 00 00 	movl   $0x0,0x5f08
    3d60:	00 00 00 
