...
shm_get(char* name)
{
 ...
 583:	5d                   	pop    %ebp
	return shmget(name);
 584:	e9 b8 00 00 00       	jmp    641 <shmget>
...
shm_rem(char* name)
{
 ...
 593:	5d                   	pop    %ebp
	return shmrem(name);
 594:	e9 b0 00 00 00       	jmp    649 <shmrem>
 ...
 669:	85 d2                	test   %edx,%edx
{
 ...
 6d0:	e8 ec fe ff ff       	call   5c1 <write>
...
printf(int fd, char *fmt, ...)
{
 ...
 740:	e8 7c fe ff ff       	call   5c1 <write>
 ...
 7a1:	e8 1b fe ff ff       	call   5c1 <write>
 ...
 853:	57                   	push   %edi
 854:	53                   	push   %ebx
 855:	e8 67 fd ff ff       	call   5c1 <write>
				while (*s != 0) {
 ...
 8a7:	e8 15 fd ff ff       	call   5c1 <write>
				ap++;
...
free(void *ap)
{
 ...
 8d1:	a1 1c 0e 00 00       	mov    0xe1c,%eax
{
 ...
 90d:	89 08                	mov    %ecx,(%eax)
	freep = p;
 90f:	a3 1c 0e 00 00       	mov    %eax,0xe1c
}
 914:	5b                   	pop    %ebx
 915:	5e                   	pop    %esi
 916:	5f                   	pop    %edi
 ...
 926:	72 ce                	jb     8f6 <free+0x26>
{
 ...
 947:	03 53 fc             	add    -0x4(%ebx),%edx
	freep = p;
 94a:	a3 1c 0e 00 00       	mov    %eax,0xe1c
		p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 969:	8b 45 08             	mov    0x8(%ebp),%eax
	if ((prevp = freep) == 0) {
 96c:	8b 15 1c 0e 00 00    	mov    0xe1c,%edx
	nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 9d6:	e8 f5 fe ff ff       	call   8d0 <free>
	return freep;
 9db:	8b 15 1c 0e 00 00    	mov    0xe1c,%edx
 ...
 a04:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
 a07:	89 15 1c 0e 00 00    	mov    %edx,0xe1c
}
 ...
 a19:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		base.s.ptr = freep = prevp = &base;
 a20:	c7 05 1c 0e 00 00 20 	movl   $0xe20,0xe1c
 a27:	0e 00 00 
 a2a:	c7 05 20 0e 00 00 20 	movl   $0xe20,0xe20
 a31:	0e 00 00 
		base.s.size                = 0;
 a34:	b8 20 0e 00 00       	mov    $0xe20,%eax
 a39:	c7 05 24 0e 00 00 00 	movl   $0x0,0xe24
 a40:	00 00 00 
