 ...
 621:	a1 cc 0a 00 00       	mov    0xacc,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
	freep = p;
 65f:	a3 cc 0a 00 00       	mov    %eax,0xacc
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
		...
		if (p == freep)
 701:	39 05 cc 0a 00 00    	cmp    %eax,0xacc
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
	return freep;
 72b:	8b 15 cc 0a 00 00    	mov    0xacc,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
 757:	89 15 cc 0a 00 00    	mov    %edx,0xacc
}
 ...
 769:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		base.s.ptr = freep = prevp = &base;
 770:	c7 05 cc 0a 00 00 d0 	movl   $0xad0,0xacc
 777:	0a 00 00 
 77a:	c7 05 d0 0a 00 00 d0 	movl   $0xad0,0xad0
 781:	0a 00 00 
		base.s.size                = 0;
 784:	b8 d0 0a 00 00       	mov    $0xad0,%eax
 789:	c7 05 d4 0a 00 00 00 	movl   $0x0,0xad4
 790:	00 00 00 
