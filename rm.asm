...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 07 03 00 00       	call   341 <unlink>
  ...
  49:	75 e5                	jne    30 <main+0x30>
	...
	exit();
  4b:	e8 a1 02 00 00       	call   2f1 <exit>
			printf(2, "rm: %s failed to delete\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	pushl  (%ebx)
  ...
  6d:	e8 1e 04 00 00       	call   490 <printf>
		exit();
  72:	e8 7a 02 00 00       	call   2f1 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 198:	89 f3                	mov    %esi,%ebx
{
 ...
 1b0:	50                   	push   %eax
 1b1:	6a 00                	push   $0x0
 1b3:	e8 51 01 00 00       	call   309 <read>
		if (cc < 1) break;
...
stat(char *n, struct stat *st)
{
 ...
 21d:	e8 0f 01 00 00       	call   331 <open>
	if (fd < 0) return -1;
 ...
 231:	50                   	push   %eax
 232:	e8 12 01 00 00       	call   349 <fstat>
	close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
	r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
	close(fd);
 23c:	e8 d8 00 00 00       	call   319 <close>
	return r;
...
shm_get(char* name)
{
 ...
 2d3:	5d                   	pop    %ebp
	return shmget(name);
 2d4:	e9 00 01 00 00       	jmp    3d9 <shmget>
...
shm_rem(char* name)
{
 ...
 2e3:	5d                   	pop    %ebp
	return shmrem(name);
 2e4:	e9 f8 00 00 00       	jmp    3e1 <shmrem>
 ...
 3f9:	85 d2                	test   %edx,%edx
{
 ...
 460:	e8 ac fe ff ff       	call   311 <write>
...
printf(int fd, char *fmt, ...)
{
 ...
 4d0:	e8 3c fe ff ff       	call   311 <write>
 ...
 531:	e8 db fd ff ff       	call   311 <write>
 ...
 548:	31 ff                	xor    %edi,%edi
	write(fd, &c, 1);
 54a:	e8 c2 fd ff ff       	call   311 <write>
	for (i = 0; fmt[i]; i++) {
 ...
 5e3:	57                   	push   %edi
 5e4:	53                   	push   %ebx
 5e5:	e8 27 fd ff ff       	call   311 <write>
				while (*s != 0) {
 ...
 637:	e8 d5 fc ff ff       	call   311 <write>
				ap++;
 ...
 661:	a1 0c 0b 00 00       	mov    0xb0c,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
	freep = p;
 69f:	a3 0c 0b 00 00       	mov    %eax,0xb0c
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
	if ((prevp = freep) == 0) {
 6fc:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
	nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
	return freep;
 76b:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
 ...
 794:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
 797:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
}
 ...
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 0c 0b 00 00 10 	movl   $0xb10,0xb0c
 7b7:	0b 00 00 
 7ba:	c7 05 10 0b 00 00 10 	movl   $0xb10,0xb10
 7c1:	0b 00 00 
		base.s.size                = 0;
 7c4:	b8 10 0b 00 00       	mov    $0xb10,%eax
 7c9:	c7 05 14 0b 00 00 00 	movl   $0x0,0xb14
 7d0:	00 00 00 
