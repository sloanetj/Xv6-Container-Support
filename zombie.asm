...
shm_get(char* name)
{
 ...
 283:	5d                   	pop    %ebp
	return shmget(name);
 284:	e9 b8 00 00 00       	jmp    341 <shmget>
...
shm_rem(char* name)
{
 ...
 293:	5d                   	pop    %ebp
	return shmrem(name);
 294:	e9 b0 00 00 00       	jmp    349 <shmrem>
 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 3d0:	e8 ec fe ff ff       	call   2c1 <write>
...
printf(int fd, char *fmt, ...)
{
 ...
 440:	e8 7c fe ff ff       	call   2c1 <write>
 ...
 4a1:	e8 1b fe ff ff       	call   2c1 <write>
 ...
 4b8:	31 ff                	xor    %edi,%edi
	write(fd, &c, 1);
 4ba:	e8 02 fe ff ff       	call   2c1 <write>
	for (i = 0; fmt[i]; i++) {
 ...
 553:	57                   	push   %edi
 554:	53                   	push   %ebx
 555:	e8 67 fd ff ff       	call   2c1 <write>
				while (*s != 0) {
 ...
 5a7:	e8 15 fd ff ff       	call   2c1 <write>
				ap++;
...
malloc(uint nbytes)
{
 ...
 6be:	56                   	push   %esi
 6bf:	e8 65 fc ff ff       	call   329 <sbrk>
