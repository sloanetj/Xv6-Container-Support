...
main(void)
{
  ...
  11:	e8 83 02 00 00       	call   299 <fork>
  16:	85 c0                	test   %eax,%eax
  18:	7e 0d                	jle    27 <main+0x27>
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 0d 03 00 00       	call   331 <sleep>
  24:	83 c4 10             	add    $0x10,%esp
	exit();
  27:	e8 75 02 00 00       	call   2a1 <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 148:	89 f3                	mov    %esi,%ebx
{
 ...
 160:	50                   	push   %eax
 161:	6a 00                	push   $0x0
 163:	e8 51 01 00 00       	call   2b9 <read>
		if (cc < 1) break;
...
stat(char *n, struct stat *st)
{
 ...
 1cd:	e8 0f 01 00 00       	call   2e1 <open>
	if (fd < 0) return -1;
 ...
 1e1:	50                   	push   %eax
 1e2:	e8 12 01 00 00       	call   2f9 <fstat>
	close(fd);
 1e7:	89 1c 24             	mov    %ebx,(%esp)
	r = fstat(fd, st);
 1ea:	89 c6                	mov    %eax,%esi
	close(fd);
 1ec:	e8 d8 00 00 00       	call   2c9 <close>
	return r;
...
shm_get(char* name)
{
 ...
 283:	5d                   	pop    %ebp
	return shmget(name);
 284:	e9 00 01 00 00       	jmp    389 <shmget>
...
shm_rem(char* name)
{
 ...
 293:	5d                   	pop    %ebp
	return shmrem(name);
 294:	e9 f8 00 00 00       	jmp    391 <shmrem>
...
00000361 <waitcv>:
SYSCALL(waitcv)
 361:	b8 1a 00 00 00       	mov    $0x1a,%eax
 366:	cd 40                	int    $0x40
 368:	c3                   	ret    

00000369 <signalcv>:
SYSCALL(signalcv)
 369:	b8 1b 00 00 00       	mov    $0x1b,%eax
 36e:	cd 40                	int    $0x40
 370:	c3                   	ret    

00000371 <prio_set>:
SYSCALL(prio_set)
 371:	b8 1c 00 00 00       	mov    $0x1c,%eax
 376:	cd 40                	int    $0x40
 378:	c3                   	ret    

00000379 <testpqeq>:
SYSCALL(testpqeq)
 379:	b8 1d 00 00 00       	mov    $0x1d,%eax
 37e:	cd 40                	int    $0x40
 380:	c3                   	ret    

00000381 <testpqdq>:
SYSCALL(testpqdq)
 381:	b8 1e 00 00 00       	mov    $0x1e,%eax
 386:	cd 40                	int    $0x40
 388:	c3                   	ret    

00000389 <shmget>:
SYSCALL(shmget)
 389:	b8 1f 00 00 00       	mov    $0x1f,%eax
 38e:	cd 40                	int    $0x40
 390:	c3                   	ret    

00000391 <shmrem>:
 391:	b8 20 00 00 00       	mov    $0x20,%eax
 396:	cd 40                	int    $0x40
 398:	c3                   	ret    
 ...
 3a9:	85 d2                	test   %edx,%edx
{
 ...
 410:	e8 ac fe ff ff       	call   2c1 <write>
...
printf(int fd, char *fmt, ...)
{
 ...
 480:	e8 3c fe ff ff       	call   2c1 <write>
 ...
 4e1:	e8 db fd ff ff       	call   2c1 <write>
 ...
 4f8:	31 ff                	xor    %edi,%edi
	write(fd, &c, 1);
 4fa:	e8 c2 fd ff ff       	call   2c1 <write>
	for (i = 0; fmt[i]; i++) {
 ...
 593:	57                   	push   %edi
 594:	53                   	push   %ebx
 595:	e8 27 fd ff ff       	call   2c1 <write>
				while (*s != 0) {
 ...
 5e7:	e8 d5 fc ff ff       	call   2c1 <write>
				ap++;
...
malloc(uint nbytes)
{
 ...
 6fe:	56                   	push   %esi
 6ff:	e8 25 fc ff ff       	call   329 <sbrk>
