...
shm_get(char* name)
{
	...
	return shmget(name);
     ...
     d13:	5d                   	pop    %ebp
	return shmget(name);
     d14:	e9 b8 00 00 00       	jmp    dd1 <shmget>
...
shm_rem(char* name)
{
	...
	return shmrem(name);
     ...
     d23:	5d                   	pop    %ebp
	return shmrem(name);
     d24:	e9 b0 00 00 00       	jmp    dd9 <shmrem>
     ...
     df9:	85 d2                	test   %edx,%edx
{
	...
	write(fd, &c, 1);
     ...
     e60:	e8 ec fe ff ff       	call   d51 <write>
...
printf(int fd, char *fmt, ...)
{
	...
	write(fd, &c, 1);
     ...
     ed0:	e8 7c fe ff ff       	call   d51 <write>
	...
	write(fd, &c, 1);
     ...
     f31:	e8 1b fe ff ff       	call   d51 <write>
	...
	write(fd, &c, 1);
     ...
     fe3:	57                   	push   %edi
     fe4:	53                   	push   %ebx
     fe5:	e8 67 fd ff ff       	call   d51 <write>
				while (*s != 0) {
    ...
    1037:	e8 15 fd ff ff       	call   d51 <write>
				ap++;
...
free(void *ap)
{
    ...
    1061:	a1 64 19 00 00       	mov    0x1964,%eax
{
	...
	freep = p;
    109f:	a3 64 19 00 00       	mov    %eax,0x1964
}
    10a4:	5b                   	pop    %ebx
    10a5:	5e                   	pop    %esi
    10a6:	5f                   	pop    %edi
    ...
    10b6:	72 ce                	jb     1086 <free+0x26>
{
	...
	freep = p;
    10da:	a3 64 19 00 00       	mov    %eax,0x1964
		p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
	...
	if ((prevp = freep) == 0) {
    10fc:	8b 15 64 19 00 00    	mov    0x1964,%edx
	nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
	...
	return freep;
    116b:	8b 15 64 19 00 00    	mov    0x1964,%edx
    ...
    1194:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
    1197:	89 15 64 19 00 00    	mov    %edx,0x1964
}
    ...
    11a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		base.s.ptr = freep = prevp = &base;
    11b0:	c7 05 64 19 00 00 68 	movl   $0x1968,0x1964
    11b7:	19 00 00 
    11ba:	c7 05 68 19 00 00 68 	movl   $0x1968,0x1968
    11c1:	19 00 00 
		base.s.size                = 0;
    11c4:	b8 68 19 00 00       	mov    $0x1968,%eax
    11c9:	c7 05 6c 19 00 00 00 	movl   $0x0,0x196c
    11d0:	00 00 00 
