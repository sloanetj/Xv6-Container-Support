...
main(void)
{
	...
	while ((fd = open("console", O_RDWR)) >= 0) {
      ...
      27:	e8 45 0d 00 00       	call   d71 <open>
...
fork1(void)
{
	...
	pid = fork();
      41:	e8 e3 0c 00 00       	call   d29 <fork>
	if (pid == -1) panic("fork");
      ...
      4d:	74 57                	je     a6 <main+0xa6>
		wait();
      4f:	e8 e5 0c 00 00       	call   d39 <wait>
	while (getcmd(buf, sizeof(buf)) >= 0) {
      54:	83 ec 08             	sub    $0x8,%esp
      57:	6a 64                	push   $0x64
      59:	68 40 19 00 00       	push   $0x1940
      5e:	e8 9d 00 00 00       	call   100 <getcmd>
      63:	83 c4 10             	add    $0x10,%esp
      66:	85 c0                	test   %eax,%eax
      68:	78 37                	js     a1 <main+0xa1>
		if (buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' ') {
      6a:	80 3d 40 19 00 00 63 	cmpb   $0x63,0x1940
      71:	75 ce                	jne    41 <main+0x41>
      73:	80 3d 41 19 00 00 64 	cmpb   $0x64,0x1941
      7a:	74 bc                	je     38 <main+0x38>
	pid = fork();
      7c:	e8 a8 0c 00 00       	call   d29 <fork>
	if (pid == -1) panic("fork");
...
00000150 <panic>:
{
	...
	exit();
     165:	e8 c7 0b 00 00       	call   d31 <exit>
...
00000170 <runcmd>:
{
	...
	switch (cmd->type) {
     ...
     19c:	52                   	push   %edx
     19d:	50                   	push   %eax
     19e:	e8 c6 0b 00 00       	call   d69 <exec>
	...
	if (cmd == 0) exit();
     1b8:	e8 74 0b 00 00       	call   d31 <exit>
	pid = fork();
     1bd:	e8 67 0b 00 00       	call   d29 <fork>
	if (pid == -1) panic("fork");
     ...
     1e0:	e8 74 0b 00 00       	call   d59 <close>
		if (open(rcmd->file, rcmd->mode) < 0) {
     1e5:	59                   	pop    %ecx
     1e6:	58                   	pop    %eax
     1e7:	ff 73 10             	pushl  0x10(%ebx)
     1ea:	ff 73 08             	pushl  0x8(%ebx)
     1ed:	e8 7f 0b 00 00       	call   d71 <open>
	...
	pid = fork();
     237:	e8 ed 0a 00 00       	call   d29 <fork>
	if (pid == -1) panic("fork");
     ...
     24b:	e8 09 0b 00 00       	call   d59 <close>
		close(p[1]);
     250:	58                   	pop    %eax
     251:	ff 75 f4             	pushl  -0xc(%ebp)
     254:	e8 00 0b 00 00       	call   d59 <close>
		wait();
     259:	e8 db 0a 00 00       	call   d39 <wait>
		wait();
     25e:	e8 d6 0a 00 00       	call   d39 <wait>
		break;
     263:	83 c4 10             	add    $0x10,%esp
     266:	e9 4d ff ff ff       	jmp    1b8 <runcmd+0x48>
	pid = fork();
     26b:	e8 b9 0a 00 00       	call   d29 <fork>
	if (pid == -1) panic("fork");
     ...
     277:	0f 84 52 ff ff ff    	je     1cf <runcmd+0x5f>
		wait();
     27d:	e8 b7 0a 00 00       	call   d39 <wait>
		runcmd(lcmd->right);
	...
	if (pid == -1) panic("fork");
     ...
     2aa:	6a 00                	push   $0x0
     2ac:	e8 a8 0a 00 00       	call   d59 <close>
			dup(p[0]);
     2b1:	5a                   	pop    %edx
     2b2:	ff 75 f0             	pushl  -0x10(%ebp)
     2b5:	e8 ef 0a 00 00       	call   da9 <dup>
			close(p[0]);
     2ba:	59                   	pop    %ecx
     2bb:	ff 75 f0             	pushl  -0x10(%ebp)
     2be:	e8 96 0a 00 00       	call   d59 <close>
			close(p[1]);
     2c3:	58                   	pop    %eax
     2c4:	ff 75 f4             	pushl  -0xc(%ebp)
     2c7:	e8 8d 0a 00 00       	call   d59 <close>
			runcmd(pcmd->right);
     2cc:	58                   	pop    %eax
     ...
     2e5:	6a 01                	push   $0x1
     2e7:	e8 6d 0a 00 00       	call   d59 <close>
			dup(p[1]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f4             	pushl  -0xc(%ebp)
     2f0:	e8 b4 0a 00 00       	call   da9 <dup>
			close(p[0]);
     2f5:	58                   	pop    %eax
     ...
     302:	e8 52 0a 00 00       	call   d59 <close>
			runcmd(pcmd->left);
     307:	58                   	pop    %eax
...
00000310 <fork1>:
{
	...
	pid = fork();
     316:	e8 0e 0a 00 00       	call   d29 <fork>
	if (pid == -1) panic("fork");
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
	...
	while (s < es && strchr(whitespace, *s)) s++;
     ...
     48d:	50                   	push   %eax
     48e:	68 1c 19 00 00       	push   $0x191c
	...
	while (s < es && strchr(whitespace, *s)) s++;
     ...
     4dd:	50                   	push   %eax
     4de:	68 1c 19 00 00       	push   $0x191c
	...
	*ps = s;
	...
	switch (*s) {
     ...
     536:	50                   	push   %eax
     537:	68 14 19 00 00       	push   $0x1914
     ...
     555:	50                   	push   %eax
     556:	68 1c 19 00 00       	push   $0x191c
...
peek(char **ps, char *es, char *toks)
{
	...
	while (s < es && strchr(whitespace, *s)) s++;
     ...
     5fd:	50                   	push   %eax
     5fe:	68 1c 19 00 00       	push   $0x191c
     ...
     bd8:	89 f3                	mov    %esi,%ebx
{
	...
	for (i = 0; i + 1 < max;) {
     ...
     bf0:	50                   	push   %eax
     bf1:	6a 00                	push   $0x0
     bf3:	e8 51 01 00 00       	call   d49 <read>
		if (cc < 1) break;
...
stat(char *n, struct stat *st)
{
	...
	fd = open(n, O_RDONLY);
     ...
     c5d:	e8 0f 01 00 00       	call   d71 <open>
	if (fd < 0) return -1;
	...
	r = fstat(fd, st);
     ...
     c71:	50                   	push   %eax
     c72:	e8 12 01 00 00       	call   d89 <fstat>
	close(fd);
     c77:	89 1c 24             	mov    %ebx,(%esp)
	r = fstat(fd, st);
     c7a:	89 c6                	mov    %eax,%esi
	close(fd);
     c7c:	e8 d8 00 00 00       	call   d59 <close>
	return r;
...
shm_get(char* name)
{
	...
	return shmget(name);
     ...
     d13:	5d                   	pop    %ebp
	return shmget(name);
     d14:	e9 00 01 00 00       	jmp    e19 <shmget>
...
shm_rem(char* name)
{
	...
	return shmrem(name);
     ...
     d23:	5d                   	pop    %ebp
	return shmrem(name);
     d24:	e9 f8 00 00 00       	jmp    e21 <shmrem>
...
00000df1 <waitcv>:
SYSCALL(waitcv)
     df1:	b8 1a 00 00 00       	mov    $0x1a,%eax
     df6:	cd 40                	int    $0x40
     df8:	c3                   	ret    

00000df9 <signalcv>:
SYSCALL(signalcv)
     df9:	b8 1b 00 00 00       	mov    $0x1b,%eax
     dfe:	cd 40                	int    $0x40
     e00:	c3                   	ret    

00000e01 <prio_set>:
SYSCALL(prio_set)
     e01:	b8 1c 00 00 00       	mov    $0x1c,%eax
     e06:	cd 40                	int    $0x40
     e08:	c3                   	ret    

00000e09 <testpqeq>:
SYSCALL(testpqeq)
     e09:	b8 1d 00 00 00       	mov    $0x1d,%eax
     e0e:	cd 40                	int    $0x40
     e10:	c3                   	ret    

00000e11 <testpqdq>:
SYSCALL(testpqdq)
     e11:	b8 1e 00 00 00       	mov    $0x1e,%eax
     e16:	cd 40                	int    $0x40
     e18:	c3                   	ret    

00000e19 <shmget>:
SYSCALL(shmget)
     e19:	b8 1f 00 00 00       	mov    $0x1f,%eax
     e1e:	cd 40                	int    $0x40
     e20:	c3                   	ret    

00000e21 <shmrem>:
     e21:	b8 20 00 00 00       	mov    $0x20,%eax
     e26:	cd 40                	int    $0x40
     e28:	c3                   	ret    
     e29:	66 90                	xchg   %ax,%ax
     ...
     e39:	85 d2                	test   %edx,%edx
{
	...
	write(fd, &c, 1);
     ...
     ea0:	e8 ac fe ff ff       	call   d51 <write>
...
printf(int fd, char *fmt, ...)
{
	...
	write(fd, &c, 1);
     ...
     f10:	e8 3c fe ff ff       	call   d51 <write>
	...
	write(fd, &c, 1);
     ...
     f71:	e8 db fd ff ff       	call   d51 <write>
	...
	write(fd, &c, 1);
     f8a:	e8 c2 fd ff ff       	call   d51 <write>
	for (i = 0; fmt[i]; i++) {
    ...
    1023:	57                   	push   %edi
    1024:	53                   	push   %ebx
    1025:	e8 27 fd ff ff       	call   d51 <write>
				while (*s != 0) {
    ...
    1077:	e8 d5 fc ff ff       	call   d51 <write>
				ap++;
...
free(void *ap)
{
    ...
    10a1:	a1 a4 19 00 00       	mov    0x19a4,%eax
{
	...
	freep = p;
    10df:	a3 a4 19 00 00       	mov    %eax,0x19a4
}
    10e4:	5b                   	pop    %ebx
    10e5:	5e                   	pop    %esi
    10e6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
	...
	if ((prevp = freep) == 0) {
    113c:	8b 15 a4 19 00 00    	mov    0x19a4,%edx
	nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
	...
	return freep;
    11ab:	8b 15 a4 19 00 00    	mov    0x19a4,%edx
    ...
    11d4:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
    11d7:	89 15 a4 19 00 00    	mov    %edx,0x19a4
}
    ...
    11e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		base.s.ptr = freep = prevp = &base;
    11f0:	c7 05 a4 19 00 00 a8 	movl   $0x19a8,0x19a4
    11f7:	19 00 00 
    11fa:	c7 05 a8 19 00 00 a8 	movl   $0x19a8,0x19a8
    1201:	19 00 00 
		base.s.size                = 0;
    1204:	b8 a8 19 00 00       	mov    $0x19a8,%eax
    1209:	c7 05 ac 19 00 00 00 	movl   $0x0,0x19ac
    1210:	00 00 00 
