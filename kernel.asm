...
80101ed8:	68 66 79 10 80       	push   $0x80107966
...
80102332:	81 fb c8 76 11 80    	cmp    $0x801176c8,%ebx
...
80102ec7:	68 c8 76 11 80       	push   $0x801176c8
...
80103614:	bb 74 2f 11 80       	mov    $0x80112f74,%ebx
{
80103619:	83 ec 10             	sub    $0x10,%esp
	acquire(&ptable.lock);
8010361c:	68 40 2f 11 80       	push   $0x80112f40
...
8010362c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103630:	81 c3 fc 00 00 00    	add    $0xfc,%ebx
80103636:	81 fb 74 6e 11 80    	cmp    $0x80116e74,%ebx
...
80103657:	89 43 10             	mov    %eax,0x10(%ebx)
	release(&ptable.lock);
8010365a:	68 40 2f 11 80       	push   $0x80112f40
	p->pid   = nextpid++;
8010365f:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
	release(&ptable.lock);
80103665:	e8 f6 0d 00 00       	call   80104460 <release>
...
80103687:	89 53 18             	mov    %edx,0x18(%ebx)
	*(uint *)sp = (uint)trapret;
8010368a:	c7 40 14 2f 57 10 80 	movl   $0x8010572f,0x14(%eax)
	p->context = (struct context *)sp;
...
80103699:	e8 22 0e 00 00       	call   801044c0 <memset>
...
801036bb:	31 db                	xor    %ebx,%ebx
	release(&ptable.lock);
801036bd:	68 40 2f 11 80       	push   $0x80112f40
801036c2:	e8 99 0d 00 00       	call   80104460 <release>
}
...
801036e3:	83 ec 14             	sub    $0x14,%esp
	...
	release(&ptable.lock);
801036e6:	68 40 2f 11 80       	push   $0x80112f40
...
80103736:	68 55 77 10 80       	push   $0x80107755
8010373b:	68 40 2f 11 80       	push   $0x80112f40
80103740:	e8 0b 0b 00 00       	call   80104250 <initlock>
}
...
801037b0:	68 5c 77 10 80       	push   $0x8010775c
801037b5:	e8 d6 cb ff ff       	call   80100390 <panic>
	if (readeflags() & FL_IF) panic("mycpu called with interrupts enabled\n");
801037ba:	83 ec 0c             	sub    $0xc,%esp
801037bd:	68 38 78 10 80       	push   $0x80107838
...
801037f4:	83 ec 04             	sub    $0x4,%esp
	pushcli();
801037f7:	e8 04 0b 00 00       	call   80104300 <pushcli>
	c = mycpu();
...
80103866:	e8 55 0c 00 00       	call   801044c0 <memset>
...
801038bf:	68 85 77 10 80       	push   $0x80107785
801038c4:	50                   	push   %eax
801038c5:	e8 d6 0d 00 00       	call   801046a0 <safestrcpy>
	p->cwd = namei("/");
801038ca:	c7 04 24 8e 77 10 80 	movl   $0x8010778e,(%esp)
801038d1:	e8 1a e6 ff ff       	call   80101ef0 <namei>
801038d6:	89 43 68             	mov    %eax,0x68(%ebx)
	acquire(&ptable.lock);
801038d9:	c7 04 24 40 2f 11 80 	movl   $0x80112f40,(%esp)
801038e0:	e8 5b 0a 00 00       	call   80104340 <acquire>
	p->state = RUNNABLE;
801038e5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
	release(&ptable.lock);
801038ec:	c7 04 24 40 2f 11 80 	movl   $0x80112f40,(%esp)
...
80103903:	68 6c 77 10 80       	push   $0x8010776c
...
80103915:	8b 75 08             	mov    0x8(%ebp),%esi
	pushcli();
80103918:	e8 e3 09 00 00       	call   80104300 <pushcli>
	c = mycpu();
...
80103996:	83 ec 1c             	sub    $0x1c,%esp
	pushcli();
80103999:	e8 62 09 00 00       	call   80104300 <pushcli>
	c = mycpu();
...
801039b8:	0f 84 04 01 00 00    	je     80103ac2 <fork+0x132>
	if ((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0) {
801039be:	83 ec 08             	sub    $0x8,%esp
801039c1:	ff 33                	pushl  (%ebx)
801039c3:	ff 73 04             	pushl  0x4(%ebx)
801039c6:	89 c6                	mov    %eax,%esi
801039c8:	e8 53 34 00 00       	call   80106e20 <copyuvm>
801039cd:	83 c4 10             	add    $0x10,%esp
801039d0:	85 c0                	test   %eax,%eax
801039d2:	89 46 04             	mov    %eax,0x4(%esi)
801039d5:	0f 84 ee 00 00 00    	je     80103ac9 <fork+0x139>
801039db:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801039de:	8d 43 7c             	lea    0x7c(%ebx),%eax
801039e1:	8d b3 fc 00 00 00    	lea    0xfc(%ebx),%esi
801039e7:	83 c2 7c             	add    $0x7c,%edx
801039ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		if(curproc->shmpgs[pg_num] != 0)
801039f0:	8b 08                	mov    (%eax),%ecx
801039f2:	85 c9                	test   %ecx,%ecx
801039f4:	74 24                	je     80103a1a <fork+0x8a>
			np->shmpgs[pg_num]->allocated = curproc->shmpgs[pg_num]->allocated;
801039f6:	8b 3a                	mov    (%edx),%edi
801039f8:	8b 09                	mov    (%ecx),%ecx
801039fa:	89 0f                	mov    %ecx,(%edi)
			np->shmpgs[pg_num]->name = curproc->shmpgs[pg_num]->name;
801039fc:	8b 38                	mov    (%eax),%edi
801039fe:	8b 0a                	mov    (%edx),%ecx
80103a00:	8b 7f 04             	mov    0x4(%edi),%edi
80103a03:	89 79 04             	mov    %edi,0x4(%ecx)
			np->shmpgs[pg_num]->pa = curproc->shmpgs[pg_num]->pa;
80103a06:	8b 38                	mov    (%eax),%edi
80103a08:	8b 0a                	mov    (%edx),%ecx
80103a0a:	8b 7f 08             	mov    0x8(%edi),%edi
80103a0d:	89 79 08             	mov    %edi,0x8(%ecx)
			np->shmpgs[pg_num]->ref_count = curproc->shmpgs[pg_num]->ref_count;
80103a10:	8b 38                	mov    (%eax),%edi
80103a12:	8b 0a                	mov    (%edx),%ecx
80103a14:	8b 7f 0c             	mov    0xc(%edi),%edi
80103a17:	89 79 0c             	mov    %edi,0xc(%ecx)
80103a1a:	83 c0 04             	add    $0x4,%eax
80103a1d:	83 c2 04             	add    $0x4,%edx
	for(pg_num = 0; pg_num < SHM_MAXNUM; pg_num++)
80103a20:	39 f0                	cmp    %esi,%eax
80103a22:	75 cc                	jne    801039f0 <fork+0x60>
	np->sz     = curproc->sz;
80103a24:	8b 03                	mov    (%ebx),%eax
80103a26:	8b 75 e4             	mov    -0x1c(%ebp),%esi
	*np->tf    = *curproc->tf;
80103a29:	b9 13 00 00 00       	mov    $0x13,%ecx
	np->sz     = curproc->sz;
80103a2e:	89 06                	mov    %eax,(%esi)
	np->parent = curproc;
80103a30:	89 f0                	mov    %esi,%eax
80103a32:	89 5e 14             	mov    %ebx,0x14(%esi)
	*np->tf    = *curproc->tf;
80103a35:	8b 73 18             	mov    0x18(%ebx),%esi
80103a38:	8b 78 18             	mov    0x18(%eax),%edi
80103a3b:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
	np->tf->eax = 0;
80103a3d:	89 c7                	mov    %eax,%edi
	for (i = 0; i < NOFILE; i++)
80103a3f:	31 f6                	xor    %esi,%esi
	np->tf->eax = 0;
80103a41:	8b 40 18             	mov    0x18(%eax),%eax
80103a44:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
80103a4b:	90                   	nop
...
80103a56:	74 10                	je     80103a68 <fork+0xd8>
...
80103a64:	89 44 b7 28          	mov    %eax,0x28(%edi,%esi,4)
	for (i = 0; i < NOFILE; i++)
80103a68:	83 c6 01             	add    $0x1,%esi
80103a6b:	83 fe 10             	cmp    $0x10,%esi
80103a6e:	75 e0                	jne    80103a50 <fork+0xc0>
	np->cwd = idup(curproc->cwd);
80103a70:	83 ec 0c             	sub    $0xc,%esp
80103a73:	ff 73 68             	pushl  0x68(%ebx)
	safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103a76:	83 c3 6c             	add    $0x6c,%ebx
	np->cwd = idup(curproc->cwd);
80103a79:	e8 e2 db ff ff       	call   80101660 <idup>
80103a7e:	8b 75 e4             	mov    -0x1c(%ebp),%esi
	safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103a81:	83 c4 0c             	add    $0xc,%esp
	np->cwd = idup(curproc->cwd);
80103a84:	89 46 68             	mov    %eax,0x68(%esi)
	safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103a87:	8d 46 6c             	lea    0x6c(%esi),%eax
80103a8a:	6a 10                	push   $0x10
80103a8c:	53                   	push   %ebx
80103a8d:	50                   	push   %eax
80103a8e:	e8 0d 0c 00 00       	call   801046a0 <safestrcpy>
	pid = np->pid;
80103a93:	8b 5e 10             	mov    0x10(%esi),%ebx
	acquire(&ptable.lock);
80103a96:	c7 04 24 40 2f 11 80 	movl   $0x80112f40,(%esp)
80103a9d:	e8 9e 08 00 00       	call   80104340 <acquire>
	np->state = RUNNABLE;
80103aa2:	c7 46 0c 03 00 00 00 	movl   $0x3,0xc(%esi)
	release(&ptable.lock);
80103aa9:	c7 04 24 40 2f 11 80 	movl   $0x80112f40,(%esp)
80103ab0:	e8 ab 09 00 00       	call   80104460 <release>
	return pid;
...
80103ac1:	c3                   	ret    
		return -1;
80103ac2:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103ac7:	eb ef                	jmp    80103ab8 <fork+0x128>
		kfree(np->kstack);
80103ac9:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103acc:	83 ec 0c             	sub    $0xc,%esp
80103acf:	ff 73 08             	pushl  0x8(%ebx)
80103ad2:	e8 49 e8 ff ff       	call   80102320 <kfree>
		np->kstack = 0;
80103ad7:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
		np->state  = UNUSED;
80103ade:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
		return -1;
80103ae5:	83 c4 10             	add    $0x10,%esp
80103ae8:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103aed:	eb c9                	jmp    80103ab8 <fork+0x128>
80103aef:	90                   	nop
...
80103b11:	83 ec 0c             	sub    $0xc,%esp
		for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103b14:	bb 74 2f 11 80       	mov    $0x80112f74,%ebx
		acquire(&ptable.lock);
80103b19:	68 40 2f 11 80       	push   $0x80112f40
...
80103b40:	e8 db 2d 00 00       	call   80106920 <switchuvm>
...
80103b52:	e8 a4 0b 00 00       	call   801046fb <swtch>
			switchkvm();
80103b57:	e8 a4 2d 00 00       	call   80106900 <switchkvm>
			c->proc = 0;
80103b5c:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103b63:	00 00 00 
80103b66:	83 c4 10             	add    $0x10,%esp
		for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103b69:	81 c3 fc 00 00 00    	add    $0xfc,%ebx
80103b6f:	81 fb 74 6e 11 80    	cmp    $0x80116e74,%ebx
80103b75:	72 b9                	jb     80103b30 <scheduler+0x40>
		release(&ptable.lock);
80103b77:	83 ec 0c             	sub    $0xc,%esp
80103b7a:	68 40 2f 11 80       	push   $0x80112f40
...
80103b95:	e8 66 07 00 00       	call   80104300 <pushcli>
	c = mycpu();
80103b9a:	e8 b1 fb ff ff       	call   80103750 <mycpu>
	p = c->proc;
...
80103bad:	68 40 2f 11 80       	push   $0x80112f40
...
80103be1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
	swtch(&p->context, mycpu()->scheduler);
80103be7:	e8 64 fb ff ff       	call   80103750 <mycpu>
...
80103bf3:	e8 03 0b 00 00       	call   801046fb <swtch>
	mycpu()->intena = intena;
80103bf8:	e8 53 fb ff ff       	call   80103750 <mycpu>
}
...
80103cb4:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
	acquire(&ptable.lock);
80103cbb:	c7 04 24 40 2f 11 80 	movl   $0x80112f40,(%esp)
...
wakeup1(void *chan)
{
	...
	for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ccd:	b8 74 2f 11 80       	mov    $0x80112f74,%eax
80103cd2:	eb 10                	jmp    80103ce4 <exit+0x94>
80103cd4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103cd8:	05 fc 00 00 00       	add    $0xfc,%eax
80103cdd:	3d 74 6e 11 80       	cmp    $0x80116e74,%eax
...
80103cef:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
	for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103cf6:	05 fc 00 00 00       	add    $0xfc,%eax
80103cfb:	3d 74 6e 11 80       	cmp    $0x80116e74,%eax
80103d00:	72 e2                	jb     80103ce4 <exit+0x94>
			p->parent = initproc;
80103d02:	8b 0d b8 a5 10 80    	mov    0x8010a5b8,%ecx
	for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103d08:	ba 74 2f 11 80       	mov    $0x80112f74,%edx
80103d0d:	eb 0f                	jmp    80103d1e <exit+0xce>
80103d0f:	90                   	nop
80103d10:	81 c2 fc 00 00 00    	add    $0xfc,%edx
80103d16:	81 fa 74 6e 11 80    	cmp    $0x80116e74,%edx
...
80103d2a:	75 e4                	jne    80103d10 <exit+0xc0>
	for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103d2c:	b8 74 2f 11 80       	mov    $0x80112f74,%eax
80103d31:	eb 11                	jmp    80103d44 <exit+0xf4>
80103d33:	90                   	nop
80103d34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103d38:	05 fc 00 00 00       	add    $0xfc,%eax
80103d3d:	3d 74 6e 11 80       	cmp    $0x80116e74,%eax
...
80103dad:	e8 de fd ff ff       	call   80103b90 <sched>
	release(&ptable.lock);
80103db2:	c7 04 24 40 2f 11 80 	movl   $0x80112f40,(%esp)
...
80103ddf:	e8 1c 05 00 00       	call   80104300 <pushcli>
	c = mycpu();
80103de4:	e8 67 f9 ff ff       	call   80103750 <mycpu>
	p = c->proc;
...
80103e00:	81 fe 40 2f 11 80    	cmp    $0x80112f40,%esi
80103e06:	74 50                	je     80103e58 <sleep+0x88>
		acquire(&ptable.lock); // DOC: sleeplock1
80103e08:	83 ec 0c             	sub    $0xc,%esp
80103e0b:	68 40 2f 11 80       	push   $0x80112f40
...
80103e2c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
		release(&ptable.lock);
80103e33:	c7 04 24 40 2f 11 80 	movl   $0x80112f40,(%esp)
...
80103e79:	68 ef 77 10 80       	push   $0x801077ef
80103e7e:	e8 0d c5 ff ff       	call   80100390 <panic>
	if (p == 0) panic("sleep");
80103e83:	83 ec 0c             	sub    $0xc,%esp
80103e86:	68 e9 77 10 80       	push   $0x801077e9
...
80103e95:	e8 66 04 00 00       	call   80104300 <pushcli>
	c = mycpu();
80103e9a:	e8 b1 f8 ff ff       	call   80103750 <mycpu>
	p = c->proc;
...
80103edf:	74 37                	je     80103f18 <wait+0x88>
		for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103ee1:	81 c3 fc 00 00 00    	add    $0xfc,%ebx
			havekids = 1;
80103ee7:	b8 01 00 00 00       	mov    $0x1,%eax
		for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80103eec:	81 fb 74 6e 11 80    	cmp    $0x80116e74,%ebx
...
80103f02:	68 40 2f 11 80       	push   $0x80112f40
...
80103f2a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
				freevm(p->pgdir);
80103f31:	e8 9a 2d 00 00       	call   80106cd0 <freevm>
				release(&ptable.lock);
80103f36:	c7 04 24 40 2f 11 80 	movl   $0x80112f40,(%esp)
				p->pid     = 0;
...
80103f71:	be ff ff ff ff       	mov    $0xffffffff,%esi
			release(&ptable.lock);
80103f76:	68 40 2f 11 80       	push   $0x80112f40
...
80103fa4:	83 c4 10             	add    $0x10,%esp
	for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fa7:	b8 74 2f 11 80       	mov    $0x80112f74,%eax
80103fac:	eb 0e                	jmp    80103fbc <wakeup+0x2c>
80103fae:	66 90                	xchg   %ax,%ax
80103fb0:	05 fc 00 00 00       	add    $0xfc,%eax
80103fb5:	3d 74 6e 11 80       	cmp    $0x80116e74,%eax
...
80103fc7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
	for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103fce:	05 fc 00 00 00       	add    $0xfc,%eax
80103fd3:	3d 74 6e 11 80       	cmp    $0x80116e74,%eax
80103fd8:	72 e2                	jb     80103fbc <wakeup+0x2c>
	wakeup1(chan);
	release(&ptable.lock);
80103fda:	c7 45 08 40 2f 11 80 	movl   $0x80112f40,0x8(%ebp)
}
...
80103ff7:	8b 5d 08             	mov    0x8(%ebp),%ebx
	...
	acquire(&ptable.lock);
80103ffa:	68 40 2f 11 80       	push   $0x80112f40
80103fff:	e8 3c 03 00 00       	call   80104340 <acquire>
80104004:	83 c4 10             	add    $0x10,%esp
	for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104007:	b8 74 2f 11 80       	mov    $0x80112f74,%eax
8010400c:	eb 0e                	jmp    8010401c <kill+0x2c>
8010400e:	66 90                	xchg   %ax,%ax
80104010:	05 fc 00 00 00       	add    $0xfc,%eax
80104015:	3d 74 6e 11 80       	cmp    $0x80116e74,%eax
...
80104038:	68 40 2f 11 80       	push   $0x80112f40
...
80104053:	68 40 2f 11 80       	push   $0x80112f40
...
80104076:	8d 75 e8             	lea    -0x18(%ebp),%esi
	...
	for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104079:	bb 74 2f 11 80       	mov    $0x80112f74,%ebx
{
...
8010408b:	68 87 7b 10 80       	push   $0x80107b87
80104090:	e8 cb c5 ff ff       	call   80100660 <cprintf>
80104095:	83 c4 10             	add    $0x10,%esp
	for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104098:	81 c3 fc 00 00 00    	add    $0xfc,%ebx
8010409e:	81 fb 74 6e 11 80    	cmp    $0x80116e74,%ebx
...
801040b1:	83 f8 05             	cmp    $0x5,%eax
			state = "???";
801040b4:	ba 00 78 10 80       	mov    $0x80107800,%edx
		if (p->state >= 0 && p->state < NELEM(states) && states[p->state])
801040b9:	77 11                	ja     801040cc <procdump+0x5c>
801040bb:	8b 14 85 60 78 10 80 	mov    -0x7fef87a0(,%eax,4),%edx
			state = "???";
801040c2:	b8 00 78 10 80       	mov    $0x80107800,%eax
...
801040d4:	68 04 78 10 80       	push   $0x80107804
...
80104119:	68 41 72 10 80       	push   $0x80107241
...
8010414a:	68 78 78 10 80       	push   $0x80107878
...
801041b3:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
	lk->pid    = myproc()->pid;
801041b9:	e8 32 f6 ff ff       	call   801037f0 <myproc>
...
801042e3:	e8 68 f4 ff ff       	call   80103750 <mycpu>
...
8010430a:	e8 41 f4 ff ff       	call   80103750 <mycpu>
...
801043eb:	68 83 78 10 80       	push   $0x80107883
...
80104445:	68 8b 78 10 80       	push   $0x8010788b
8010444a:	e8 41 bf ff ff       	call   80100390 <panic>
	if (--mycpu()->ncli < 0) panic("popcli");
8010444f:	83 ec 0c             	sub    $0xc,%esp
80104452:	68 a2 78 10 80       	push   $0x801078a2
...
801047c5:	e8 26 f0 ff ff       	call   801037f0 <myproc>
...
801047d3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
	struct proc *curproc = myproc();
801047d6:	e8 15 f0 ff ff       	call   801037f0 <myproc>
	if (addr >= curproc->sz || addr + 4 > curproc->sz) return -1;
...
80104818:	8b 5d 10             	mov    0x10(%ebp),%ebx
	int          i;
	struct proc *curproc = myproc();
8010481b:	e8 d0 ef ff ff       	call   801037f0 <myproc>
...
801048b4:	83 ec 04             	sub    $0x4,%esp
	int          num;
	struct proc *curproc = myproc();
801048b7:	e8 34 ef ff ff       	call   801037f0 <myproc>
...
801048cc:	8b 14 85 e0 78 10 80 	mov    -0x7fef8720(,%eax,4),%edx
...
801048f0:	68 b1 78 10 80       	push   $0x801078b1
...
80104a44:	68 5c 79 10 80       	push   $0x8010795c
...
80104a5c:	68 5b 79 10 80       	push   $0x8010795b
...
80104a75:	68 4f 79 10 80       	push   $0x8010794f
...
80104a8a:	68 5e 79 10 80       	push   $0x8010795e
80104a8f:	e8 fc b8 ff ff       	call   80100390 <panic>
	if ((ip = ialloc(dp->dev, type)) == 0) panic("create: ialloc");
80104a94:	83 ec 0c             	sub    $0xc,%esp
80104a97:	68 40 79 10 80       	push   $0x80107940
...
80104e89:	58                   	pop    %eax
80104e8a:	5a                   	pop    %edx
80104e8b:	68 5c 79 10 80       	push   $0x8010795c
...
80104ea4:	68 5b 79 10 80       	push   $0x8010795b
...
801055e0:	68 80 6e 11 80       	push   $0x80116e80
...
801055ed:	83 c4 10             	add    $0x10,%esp
	ticks0 = ticks;
801055f0:	8b 1d c0 76 11 80    	mov    0x801176c0,%ebx
	while (ticks - ticks0 < n) {
...
80105603:	68 80 6e 11 80       	push   $0x80116e80
80105608:	68 c0 76 11 80       	push   $0x801176c0
8010560d:	e8 be e7 ff ff       	call   80103dd0 <sleep>
	while (ticks - ticks0 < n) {
80105612:	a1 c0 76 11 80       	mov    0x801176c0,%eax
...
80105630:	68 80 6e 11 80       	push   $0x80116e80
...
80105653:	68 80 6e 11 80       	push   $0x80116e80
...
80105674:	83 ec 10             	sub    $0x10,%esp
	...
	acquire(&tickslock);
80105677:	68 80 6e 11 80       	push   $0x80116e80
8010567c:	e8 bf ec ff ff       	call   80104340 <acquire>
	xticks = ticks;
80105681:	8b 1d c0 76 11 80    	mov    0x801176c0,%ebx
	release(&tickslock);
80105687:	c7 04 24 80 6e 11 80 	movl   $0x80116e80,(%esp)
...
801056b8:	ba a1 79 10 80       	mov    $0x801079a1,%edx
801056bd:	78 10                	js     801056cf <sys_shmget+0x2f>

	return shmget(name);
801056bf:	83 ec 0c             	sub    $0xc,%esp
801056c2:	ff 75 f4             	pushl  -0xc(%ebp)
801056c5:	e8 16 19 00 00       	call   80106fe0 <shmget>
...
801056ee:	e8 1d f1 ff ff       	call   80104810 <argptr>
801056f3:	83 c4 10             	add    $0x10,%esp
801056f6:	85 c0                	test   %eax,%eax
801056f8:	78 16                	js     80105710 <sys_shmrem+0x30>

	return shmrem(name);
801056fa:	83 ec 0c             	sub    $0xc,%esp
801056fd:	ff 75 f4             	pushl  -0xc(%ebp)
80105700:	e8 6b 1a 00 00       	call   80107170 <shmrem>
...
80105757:	c7 04 c5 c2 6e 11 80 	movl   $0x8e000008,-0x7fee913e(,%eax,8)
8010575e:	08 00 00 8e 
80105762:	66 89 14 c5 c0 6e 11 	mov    %dx,-0x7fee9140(,%eax,8)
80105769:	80 
8010576a:	c1 ea 10             	shr    $0x10,%edx
8010576d:	66 89 14 c5 c6 6e 11 	mov    %dx,-0x7fee913a(,%eax,8)
80105774:	80 
...
80105784:	83 ec 08             	sub    $0x8,%esp
	SETGATE(idt[T_SYSCALL], 1, SEG_KCODE << 3, vectors[T_SYSCALL], DPL_USER);
80105787:	c7 05 c2 70 11 80 08 	movl   $0xef000008,0x801170c2
8010578e:	00 00 ef 
	initlock(&tickslock, "time");
80105791:	68 a8 79 10 80       	push   $0x801079a8
80105796:	68 80 6e 11 80       	push   $0x80116e80
	SETGATE(idt[T_SYSCALL], 1, SEG_KCODE << 3, vectors[T_SYSCALL], DPL_USER);
8010579b:	66 a3 c0 70 11 80    	mov    %ax,0x801170c0
801057a1:	c1 e8 10             	shr    $0x10,%eax
801057a4:	66 a3 c6 70 11 80    	mov    %ax,0x801170c6
	initlock(&tickslock, "time");
801057aa:	e8 a1 ea ff ff       	call   80104250 <initlock>
}
...
801057cb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
	pd[1] = (uint)p;
801057cf:	b8 c0 6e 11 80       	mov    $0x80116ec0,%eax
...
80105810:	ff 24 85 50 7a 10 80 	jmp    *-0x7fef85b0(,%eax,4)
...
80105875:	68 0c 7a 10 80       	push   $0x80107a0c
...
8010590d:	89 78 18             	mov    %edi,0x18(%eax)
		syscall();
80105910:	e8 9b ef ff ff       	call   801048b0 <syscall>
		if (myproc()->killed) exit();
...
801059b7:	68 b4 79 10 80       	push   $0x801079b4
...
80105a13:	68 80 6e 11 80       	push   $0x80116e80
80105a18:	e8 23 e9 ff ff       	call   80104340 <acquire>
			wakeup(&ticks);
80105a1d:	c7 04 24 c0 76 11 80 	movl   $0x801176c0,(%esp)
			ticks++;
80105a24:	83 05 c0 76 11 80 01 	addl   $0x1,0x801176c0
			wakeup(&ticks);
80105a2b:	e8 60 e5 ff ff       	call   80103f90 <wakeup>
			release(&tickslock);
80105a30:	c7 04 24 80 6e 11 80 	movl   $0x80116e80,(%esp)
80105a37:	e8 24 ea ff ff       	call   80104460 <release>
...
80105a55:	68 d8 79 10 80       	push   $0x801079d8
80105a5a:	e8 01 ac ff ff       	call   80100660 <cprintf>
			panic("trap");
80105a5f:	83 c4 14             	add    $0x14,%esp
80105a62:	68 ad 79 10 80       	push   $0x801079ad
...
80105b5c:	83 ec 08             	sub    $0x8,%esp
	for (p = "xv6...\n"; *p; p++) uartputc(*p);
80105b5f:	bb d0 7a 10 80       	mov    $0x80107ad0,%ebx
	ioapicenable(IRQ_COM1, 0);
...
8010676d:	68 d8 7a 10 80       	push   $0x80107ad8
...
80106812:	68 66 74 10 80       	push   $0x80107466
...
80106821:	b8 24 2d 11 80       	mov    $0x80112d24,%eax
{
80106826:	89 e5                	mov    %esp,%ebp
80106828:	90                   	nop
80106829:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		pg->allocated = 0;
80106830:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
		pg->name = 0;
80106836:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	for(pg = shmtable.pages; pg < &shmtable.pages[SHM_MAXNUM]; pg++)
8010683d:	83 c0 10             	add    $0x10,%eax
		pg->pa = 0;
80106840:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
		pg->ref_count = 0;
80106847:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
	for(pg = shmtable.pages; pg < &shmtable.pages[SHM_MAXNUM]; pg++)
8010684e:	3d 24 2f 11 80       	cmp    $0x80112f24,%eax
80106853:	72 db                	jb     80106830 <shminit+0x10>
	shmtable.initialized = 1;
80106855:	c7 05 20 2d 11 80 01 	movl   $0x1,0x80112d20
8010685c:	00 00 00 
}
8010685f:	5d                   	pop    %ebp
80106860:	c3                   	ret    
80106861:	eb 0d                	jmp    80106870 <seginit>
80106863:	90                   	nop
80106864:	90                   	nop
80106865:	90                   	nop
80106866:	90                   	nop
...
80106900:	a1 c4 76 11 80       	mov    0x801176c4,%eax
{
...
80106944:	0f 84 c2 00 00 00    	je     80106a0c <switchuvm+0xec>
	pushcli();
8010694a:	e8 b1 d9 ff ff       	call   80104300 <pushcli>
...
80106a5f:	e8 5c da ff ff       	call   801044c0 <memset>
...
80106a79:	e8 72 fc ff ff       	call   801066f0 <mappages>
	memmove(mem, init, sz);
...
80106a90:	5d                   	pop    %ebp
	memmove(mem, init, sz);
80106a91:	e9 da da ff ff       	jmp    80104570 <memmove>
	if (sz >= PGSIZE) panic("inituvm: more than a page");
80106a96:	83 ec 0c             	sub    $0xc,%esp
80106a99:	68 1d 7b 10 80       	push   $0x80107b1d
...
80106af3:	e8 78 fb ff ff       	call   80106670 <walkpgdir>
...
80106b4d:	68 37 7b 10 80       	push   $0x80107b37
80106b52:	e8 39 98 ff ff       	call   80100390 <panic>
	if ((uint)addr % PGSIZE != 0) panic("loaduvm: addr must be page aligned");
80106b57:	83 ec 0c             	sub    $0xc,%esp
80106b5a:	68 d8 7b 10 80       	push   $0x80107bd8
...
80106bbb:	e8 00 d9 ff ff       	call   801044c0 <memset>
...
80106bd4:	e8 17 fb ff ff       	call   801066f0 <mappages>
...
80106bfd:	68 55 7b 10 80       	push   $0x80107b55
...
80106c33:	68 6d 7b 10 80       	push   $0x80107b6d
...
80106c50:	e8 2b fb ff ff       	call   80106780 <deallocuvm.part.0>
			kfree(mem);
...
80106c8a:	e8 f1 fa ff ff       	call   80106780 <deallocuvm.part.0>
...
80106cb0:	5d                   	pop    %ebp
80106cb1:	e9 ca fa ff ff       	jmp    80106780 <deallocuvm.part.0>
...
80106ce9:	e8 92 fa ff ff       	call   80106780 <deallocuvm.part.0>
...
80106d3c:	68 89 7b 10 80       	push   $0x80107b89
...
80106d70:	e8 4b d7 ff ff       	call   801044c0 <memset>
...
80106d8b:	e8 60 f9 ff ff       	call   801066f0 <mappages>
...
80106ddb:	a3 c4 76 11 80       	mov    %eax,0x801176c4
	lcr3(V2P(kpgdir)); // switch to the kernel page table
...
80106dfe:	e8 6d f8 ff ff       	call   80106670 <walkpgdir>
...
80106e0f:	68 9a 7b 10 80       	push   $0x80107b9a
...
80106e63:	e8 08 d7 ff ff       	call   80104570 <memmove>
...
80106e7f:	e8 6c f8 ff ff       	call   801066f0 <mappages>
...
80106e9d:	e8 ce f7 ff ff       	call   80106670 <walkpgdir>
...
80106ee7:	68 a4 7b 10 80       	push   $0x80107ba4
80106eec:	e8 9f 94 ff ff       	call   80100390 <panic>
		if (!(*pte & PTE_P)) panic("copyuvm: page not present");
80106ef1:	83 ec 0c             	sub    $0xc,%esp
80106ef4:	68 be 7b 10 80       	push   $0x80107bbe
...
80106fe9:	a1 20 2d 11 80       	mov    0x80112d20,%eax
{
80106fee:	8b 55 08             	mov    0x8(%ebp),%edx
	if(shmtable.initialized == 0)
80106ff1:	85 c0                	test   %eax,%eax
80106ff3:	75 3a                	jne    8010702f <shmget+0x4f>
	for(pg = shmtable.pages; pg < &shmtable.pages[SHM_MAXNUM]; pg++)
80106ff5:	b8 24 2d 11 80       	mov    $0x80112d24,%eax
80106ffa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		pg->allocated = 0;
80107000:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
		pg->name = 0;
80107006:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
	for(pg = shmtable.pages; pg < &shmtable.pages[SHM_MAXNUM]; pg++)
8010700d:	83 c0 10             	add    $0x10,%eax
		pg->pa = 0;
80107010:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
		pg->ref_count = 0;
80107017:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
	for(pg = shmtable.pages; pg < &shmtable.pages[SHM_MAXNUM]; pg++)
8010701e:	3d 24 2f 11 80       	cmp    $0x80112f24,%eax
80107023:	72 db                	jb     80107000 <shmget+0x20>
	shmtable.initialized = 1;
80107025:	c7 05 20 2d 11 80 01 	movl   $0x1,0x80112d20
8010702c:	00 00 00 
		shminit();
	}
	...
	char* vas = NULL;
	int pg_num = 0;
8010702f:	31 f6                	xor    %esi,%esi

	//see if the name already exists in the table
	for(pg = shmtable.pages; pg < &shmtable.pages[SHM_MAXNUM]; pg++, pg_num++)
80107031:	bb 24 2d 11 80       	mov    $0x80112d24,%ebx
80107036:	eb 1a                	jmp    80107052 <shmget+0x72>
80107038:	90                   	nop
80107039:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107040:	83 c3 10             	add    $0x10,%ebx
80107043:	83 c6 01             	add    $0x1,%esi
80107046:	81 fb 24 2f 11 80    	cmp    $0x80112f24,%ebx
8010704c:	0f 83 7e 00 00 00    	jae    801070d0 <shmget+0xf0>
	{

		if(pg->name == name)
80107052:	39 53 04             	cmp    %edx,0x4(%ebx)
80107055:	75 e9                	jne    80107040 <shmget+0x60>
		{
			mappages(myproc()->pgdir, (void*)PGROUNDUP(myproc()->sz), PGSIZE, V2P(pg->pa), PTE_W | PTE_U);
80107057:	8b 43 08             	mov    0x8(%ebx),%eax
8010705a:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
80107060:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
80107063:	e8 88 c7 ff ff       	call   801037f0 <myproc>
80107068:	8b 38                	mov    (%eax),%edi
8010706a:	e8 81 c7 ff ff       	call   801037f0 <myproc>
8010706f:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80107072:	8b 40 04             	mov    0x4(%eax),%eax
80107075:	83 ec 08             	sub    $0x8,%esp
80107078:	81 c7 ff 0f 00 00    	add    $0xfff,%edi
8010707e:	6a 06                	push   $0x6
80107080:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
80107086:	51                   	push   %ecx
80107087:	89 fa                	mov    %edi,%edx
80107089:	b9 00 10 00 00       	mov    $0x1000,%ecx
8010708e:	e8 5d f6 ff ff       	call   801066f0 <mappages>
			pg->ref_count++;
80107093:	83 43 0c 01          	addl   $0x1,0xc(%ebx)
			pg->allocated = 1;
			pg->pa = kalloc();
			pg->ref_count = 1;
...
80107097:	e8 54 c7 ff ff       	call   801037f0 <myproc>
8010709c:	8b 38                	mov    (%eax),%edi
			myproc()->sz += PGSIZE;
8010709e:	e8 4d c7 ff ff       	call   801037f0 <myproc>
801070a3:	81 00 00 10 00 00    	addl   $0x1000,(%eax)
			vas = (char*)PGROUNDUP(myproc()->sz);
801070a9:	81 c7 ff 0f 00 00    	add    $0xfff,%edi
801070af:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
			myproc()->shmpgs[pg_num] = pg;
801070b5:	e8 36 c7 ff ff       	call   801037f0 <myproc>

			return (char*)vas;
801070ba:	83 c4 10             	add    $0x10,%esp
			myproc()->shmpgs[pg_num] = pg;
801070bd:	89 5c b0 7c          	mov    %ebx,0x7c(%eax,%esi,4)
		}
	}
...
801070cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	for(pg = shmtable.pages; pg < &shmtable.pages[SHM_MAXNUM]; pg++, pg_num++)
801070d0:	bb 24 2d 11 80       	mov    $0x80112d24,%ebx
801070d5:	eb 17                	jmp    801070ee <shmget+0x10e>
801070d7:	89 f6                	mov    %esi,%esi
801070d9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
801070e0:	83 c3 10             	add    $0x10,%ebx
801070e3:	83 c6 01             	add    $0x1,%esi
801070e6:	81 fb 24 2f 11 80    	cmp    $0x80112f24,%ebx
801070ec:	73 6f                	jae    8010715d <shmget+0x17d>
		if(pg->name == 0)
801070ee:	8b 7b 04             	mov    0x4(%ebx),%edi
801070f1:	85 ff                	test   %edi,%edi
801070f3:	75 eb                	jne    801070e0 <shmget+0x100>
			pg->name = name;
801070f5:	89 53 04             	mov    %edx,0x4(%ebx)
			pg->allocated = 1;
801070f8:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
			pg->pa = kalloc();
801070fe:	e8 cd b3 ff ff       	call   801024d0 <kalloc>
			memset(pg->pa, 0, PGSIZE);
80107103:	83 ec 04             	sub    $0x4,%esp
			pg->pa = kalloc();
80107106:	89 43 08             	mov    %eax,0x8(%ebx)
			pg->ref_count = 1;
80107109:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
			memset(pg->pa, 0, PGSIZE);
80107110:	68 00 10 00 00       	push   $0x1000
80107115:	6a 00                	push   $0x0
80107117:	50                   	push   %eax
80107118:	e8 a3 d3 ff ff       	call   801044c0 <memset>
			mappages(myproc()->pgdir, (void*)PGROUNDUP(myproc()->sz), PGSIZE, V2P(pg->pa), PTE_W | PTE_U);
8010711d:	8b 43 08             	mov    0x8(%ebx),%eax
80107120:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
80107126:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
80107129:	e8 c2 c6 ff ff       	call   801037f0 <myproc>
8010712e:	8b 38                	mov    (%eax),%edi
80107130:	e8 bb c6 ff ff       	call   801037f0 <myproc>
80107135:	5a                   	pop    %edx
80107136:	59                   	pop    %ecx
80107137:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010713a:	81 c7 ff 0f 00 00    	add    $0xfff,%edi
80107140:	8b 40 04             	mov    0x4(%eax),%eax
80107143:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
80107149:	6a 06                	push   $0x6
8010714b:	89 fa                	mov    %edi,%edx
8010714d:	51                   	push   %ecx
8010714e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107153:	e8 98 f5 ff ff       	call   801066f0 <mappages>
80107158:	e9 3a ff ff ff       	jmp    80107097 <shmget+0xb7>
	return NULL;
8010715d:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80107162:	e9 5a ff ff ff       	jmp    801070c1 <shmget+0xe1>
...
80107177:	8b 55 08             	mov    0x8(%ebp),%edx


	for(pg = shmtable.pages; pg < &shmtable.pages[SHM_MAXNUM]; pg++, pg_num++)
8010717a:	bb 24 2d 11 80       	mov    $0x80112d24,%ebx
8010717f:	eb 15                	jmp    80107196 <shmrem+0x26>
80107181:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80107188:	83 c3 10             	add    $0x10,%ebx
8010718b:	83 c6 01             	add    $0x1,%esi
8010718e:	81 fb 24 2f 11 80    	cmp    $0x80112f24,%ebx
80107194:	73 4a                	jae    801071e0 <shmrem+0x70>
	{

		if(pg->name == name)
80107196:	39 53 04             	cmp    %edx,0x4(%ebx)
80107199:	75 ed                	jne    80107188 <shmrem+0x18>
		{
			pg->ref_count--;

			if(pg->ref_count == 0)
8010719b:	83 6b 0c 01          	subl   $0x1,0xc(%ebx)
8010719f:	75 e7                	jne    80107188 <shmrem+0x18>
			{
				myproc()->shmpgs[pg_num] = 0;
801071a1:	e8 4a c6 ff ff       	call   801037f0 <myproc>
				kfree(pg->pa);
801071a6:	83 ec 0c             	sub    $0xc,%esp
				myproc()->shmpgs[pg_num] = 0;
801071a9:	c7 44 b0 7c 00 00 00 	movl   $0x0,0x7c(%eax,%esi,4)
801071b0:	00 
				kfree(pg->pa);
801071b1:	ff 73 08             	pushl  0x8(%ebx)
801071b4:	e8 67 b1 ff ff       	call   80102320 <kfree>
				pg->allocated = 0;
				pg->pa = 0;
				pg->name = 0;
				return pg->ref_count;
801071b9:	8b 43 0c             	mov    0xc(%ebx),%eax
				pg->allocated = 0;
801071bc:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
				return pg->ref_count;
801071c2:	83 c4 10             	add    $0x10,%esp
				pg->pa = 0;
801071c5:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
				pg->name = 0;
801071cc:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
		}
	}
...
801071d3:	8d 65 f8             	lea    -0x8(%ebp),%esp
801071d6:	5b                   	pop    %ebx
801071d7:	5e                   	pop    %esi
801071d8:	5d                   	pop    %ebp
801071d9:	c3                   	ret    
801071da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801071e0:	8d 65 f8             	lea    -0x8(%ebp),%esp
	return -1;
