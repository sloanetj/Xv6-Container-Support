...
shm_get(char* name)
{
 ...
 3d3:	5d                   	pop    %ebp
	return shmget(name);
 3d4:	e9 b8 00 00 00       	jmp    491 <shmget>
...
shm_rem(char* name)
{
 ...
 3e3:	5d                   	pop    %ebp
	return shmrem(name);
 3e4:	e9 b0 00 00 00       	jmp    499 <shmrem>
 ...
 4b9:	85 d2                	test   %edx,%edx
{
 ...
 520:	e8 ec fe ff ff       	call   411 <write>
...
printf(int fd, char *fmt, ...)
{
 ...
 590:	e8 7c fe ff ff       	call   411 <write>
 ...
 5f1:	e8 1b fe ff ff       	call   411 <write>
 ...
 608:	31 ff                	xor    %edi,%edi
	write(fd, &c, 1);
 60a:	e8 02 fe ff ff       	call   411 <write>
	for (i = 0; fmt[i]; i++) {
 ...
 6a3:	57                   	push   %edi
 6a4:	53                   	push   %ebx
 6a5:	e8 67 fd ff ff       	call   411 <write>
				while (*s != 0) {
 ...
 6f7:	e8 15 fd ff ff       	call   411 <write>
				ap++;
...
malloc(uint nbytes)
{
 ...
 80e:	56                   	push   %esi
 80f:	e8 65 fc ff ff       	call   479 <sbrk>
