  ...
  21:	83 f8 01             	cmp    $0x1,%eax
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	pushl  (%ebx)
  37:	e8 f5 03 00 00       	call   431 <open>
  ...
  59:	e8 bb 03 00 00       	call   419 <close>
	for (i = 1; i < argc; i++) {
  ...
  64:	75 ca                	jne    30 <main+0x30>
	...
	exit();
  66:	e8 86 03 00 00       	call   3f1 <exit>
			printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	pushl  (%ebx)
  ...
  75:	e8 16 05 00 00       	call   590 <printf>
			exit();
  7a:	e8 72 03 00 00       	call   3f1 <exit>
		wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
		exit();
  8d:	e8 5f 03 00 00       	call   3f1 <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 34 03 00 00       	call   409 <read>
 ...
 16f:	e8 1c 04 00 00       	call   590 <printf>
		exit();
 174:	e8 78 02 00 00       	call   3f1 <exit>
 ...
 298:	89 f3                	mov    %esi,%ebx
{
 ...
 2b0:	50                   	push   %eax
 2b1:	6a 00                	push   $0x0
 2b3:	e8 51 01 00 00       	call   409 <read>
		if (cc < 1) break;
...
stat(char *n, struct stat *st)
{
 ...
 31d:	e8 0f 01 00 00       	call   431 <open>
	if (fd < 0) return -1;
 ...
 331:	50                   	push   %eax
 332:	e8 12 01 00 00       	call   449 <fstat>
	close(fd);
 337:	89 1c 24             	mov    %ebx,(%esp)
	r = fstat(fd, st);
 33a:	89 c6                	mov    %eax,%esi
	close(fd);
 33c:	e8 d8 00 00 00       	call   419 <close>
	return r;
...
shm_get(char* name)
{
 ...
 3d3:	5d                   	pop    %ebp
	return shmget(name);
 3d4:	e9 00 01 00 00       	jmp    4d9 <shmget>
...
shm_rem(char* name)
{
 ...
 3e3:	5d                   	pop    %ebp
	return shmrem(name);
 3e4:	e9 f8 00 00 00       	jmp    4e1 <shmrem>
...
000004c1 <prio_set>:
SYSCALL(prio_set)
 4c1:	b8 1c 00 00 00       	mov    $0x1c,%eax
 4c6:	cd 40                	int    $0x40
 4c8:	c3                   	ret    

000004c9 <testpqeq>:
SYSCALL(testpqeq)
 4c9:	b8 1d 00 00 00       	mov    $0x1d,%eax
 4ce:	cd 40                	int    $0x40
 4d0:	c3                   	ret    

000004d1 <testpqdq>:
SYSCALL(testpqdq)
 4d1:	b8 1e 00 00 00       	mov    $0x1e,%eax
 4d6:	cd 40                	int    $0x40
 4d8:	c3                   	ret    

000004d9 <shmget>:
SYSCALL(shmget)
 4d9:	b8 1f 00 00 00       	mov    $0x1f,%eax
 4de:	cd 40                	int    $0x40
 4e0:	c3                   	ret    

000004e1 <shmrem>:
 4e1:	b8 20 00 00 00       	mov    $0x20,%eax
 4e6:	cd 40                	int    $0x40
 4e8:	c3                   	ret    
 ...
 4f9:	85 d2                	test   %edx,%edx
{
 ...
 560:	e8 ac fe ff ff       	call   411 <write>
...
printf(int fd, char *fmt, ...)
{
 ...
 5d0:	e8 3c fe ff ff       	call   411 <write>
 ...
 631:	e8 db fd ff ff       	call   411 <write>
 ...
 648:	31 ff                	xor    %edi,%edi
	write(fd, &c, 1);
 64a:	e8 c2 fd ff ff       	call   411 <write>
	for (i = 0; fmt[i]; i++) {
 ...
 6e3:	57                   	push   %edi
 6e4:	53                   	push   %ebx
 6e5:	e8 27 fd ff ff       	call   411 <write>
				while (*s != 0) {
 ...
 737:	e8 d5 fc ff ff       	call   411 <write>
				ap++;
...
free(void *ap)
{
 ...
 761:	a1 60 0c 00 00       	mov    0xc60,%eax
{
 ...
 79d:	89 08                	mov    %ecx,(%eax)
	freep = p;
 79f:	a3 60 0c 00 00       	mov    %eax,0xc60
}
 7a4:	5b                   	pop    %ebx
 7a5:	5e                   	pop    %esi
 7a6:	5f                   	pop    %edi
 ...
 7b6:	72 ce                	jb     786 <free+0x26>
{
 ...
 7d7:	03 53 fc             	add    -0x4(%ebx),%edx
	freep = p;
 7da:	a3 60 0c 00 00       	mov    %eax,0xc60
		p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 84e:	56                   	push   %esi
 84f:	e8 25 fc ff ff       	call   479 <sbrk>
 ...
 866:	e8 f5 fe ff ff       	call   760 <free>
	return freep;
 86b:	8b 15 60 0c 00 00    	mov    0xc60,%edx
 ...
 894:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
 897:	89 15 60 0c 00 00    	mov    %edx,0xc60
}
 ...
 8c1:	0c 00 00 
		base.s.size                = 0;
 8c4:	b8 64 0c 00 00       	mov    $0xc64,%eax
 8c9:	c7 05 68 0c 00 00 00 	movl   $0x0,0xc68
 8d0:	00 00 00 
