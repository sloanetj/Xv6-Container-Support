...
shm_get(char* name)
{
 ...
 343:	5d                   	pop    %ebp
	return shmget(name);
 344:	e9 b8 00 00 00       	jmp    401 <shmget>
...
shm_rem(char* name)
{
 ...
 353:	5d                   	pop    %ebp
	return shmrem(name);
 354:	e9 b0 00 00 00       	jmp    409 <shmrem>
 ...
 429:	85 d2                	test   %edx,%edx
{
 ...
 490:	e8 ec fe ff ff       	call   381 <write>
...
printf(int fd, char *fmt, ...)
{
 ...
 561:	e8 1b fe ff ff       	call   381 <write>
 ...
 613:	57                   	push   %edi
 614:	53                   	push   %ebx
 615:	e8 67 fd ff ff       	call   381 <write>
				while (*s != 0) {
 ...
 667:	e8 15 fd ff ff       	call   381 <write>
				ap++;
 ...
 691:	a1 60 0b 00 00       	mov    0xb60,%eax
{
 ...
 6cd:	89 08                	mov    %ecx,(%eax)
	freep = p;
 6cf:	a3 60 0b 00 00       	mov    %eax,0xb60
}
 6d4:	5b                   	pop    %ebx
 6d5:	5e                   	pop    %esi
 6d6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 76f:	73 47                	jae    7b8 <malloc+0x98>
		...
		if (p == freep)
 771:	39 05 60 0b 00 00    	cmp    %eax,0xb60
 777:	89 c2                	mov    %eax,%edx
 779:	75 ed                	jne    768 <malloc+0x48>
	p = sbrk(nu * sizeof(Header));
 77b:	83 ec 0c             	sub    $0xc,%esp
 77e:	56                   	push   %esi
 77f:	e8 65 fc ff ff       	call   3e9 <sbrk>
 ...
 796:	e8 f5 fe ff ff       	call   690 <free>
	return freep;
 79b:	8b 15 60 0b 00 00    	mov    0xb60,%edx
 ...
 7e7:	0b 00 00 
 7ea:	c7 05 64 0b 00 00 64 	movl   $0xb64,0xb64
 7f1:	0b 00 00 
		base.s.size                = 0;
 7f4:	b8 64 0b 00 00       	mov    $0xb64,%eax
 7f9:	c7 05 68 0b 00 00 00 	movl   $0x0,0xb68
 800:	00 00 00 
