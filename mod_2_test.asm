...
_mod_2_test:     file format elf32-i386
...
main(void)
{
  ...
  if(fork() == 0)
   f:	e8 45 03 00 00       	call   359 <fork>
  14:	85 c0                	test   %eax,%eax
  16:	75 25                	jne    3d <main+0x3d>
    {
      shared_memory_address1 = shm_get("test");
  18:	83 ec 0c             	sub    $0xc,%esp
  1b:	68 58 08 00 00       	push   $0x858
  20:	e8 1b 03 00 00       	call   340 <shm_get>
      *shared_memory_address1 = 4;
      printf(1, "%d \n", shared_memory_address1);
  25:	83 c4 0c             	add    $0xc,%esp
      *shared_memory_address1 = 4;
  28:	c6 00 04             	movb   $0x4,(%eax)
  ...
  2b:	50                   	push   %eax
  2c:	68 5d 08 00 00       	push   $0x85d
  31:	6a 01                	push   $0x1
  33:	e8 c8 04 00 00       	call   500 <printf>



    exit();
  38:	e8 24 03 00 00       	call   361 <exit>
    sleep(10);
  3d:	83 ec 0c             	sub    $0xc,%esp
  40:	6a 0a                	push   $0xa
  42:	e8 aa 03 00 00       	call   3f1 <sleep>
    char* shared_memory_address2 = shm_get("test");
  47:	c7 04 24 58 08 00 00 	movl   $0x858,(%esp)
  4e:	e8 ed 02 00 00       	call   340 <shm_get>
  53:	89 c3                	mov    %eax,%ebx
    printf(1, "%d \n", *shared_memory_address2);
  55:	0f be 00             	movsbl (%eax),%eax
  58:	83 c4 0c             	add    $0xc,%esp
  5b:	50                   	push   %eax
  5c:	68 5d 08 00 00       	push   $0x85d
  61:	6a 01                	push   $0x1
  63:	e8 98 04 00 00       	call   500 <printf>
    printf(1, "%d \n", shared_memory_address2);
  68:	83 c4 0c             	add    $0xc,%esp
  6b:	53                   	push   %ebx
  6c:	68 5d 08 00 00       	push   $0x85d
  71:	6a 01                	push   $0x1
  73:	e8 88 04 00 00       	call   500 <printf>
    *shared_memory_address2 += 4;
  78:	80 03 04             	addb   $0x4,(%ebx)
    char* shared_memory_address3 = shm_get("test");
  7b:	c7 04 24 58 08 00 00 	movl   $0x858,(%esp)
  82:	e8 b9 02 00 00       	call   340 <shm_get>
    printf(1, "%d \n", *shared_memory_address3);
  87:	0f be 00             	movsbl (%eax),%eax
  8a:	83 c4 0c             	add    $0xc,%esp
  8d:	50                   	push   %eax
  8e:	68 5d 08 00 00       	push   $0x85d
  93:	6a 01                	push   $0x1
  95:	e8 66 04 00 00       	call   500 <printf>
    wait();
  9a:	e8 ca 02 00 00       	call   369 <wait>
    shm_rem("test");
  9f:	c7 04 24 58 08 00 00 	movl   $0x858,(%esp)
  a6:	e8 a5 02 00 00       	call   350 <shm_rem>
    char* shared_memory_address4 = shm_get("test");
  ab:	c7 04 24 58 08 00 00 	movl   $0x858,(%esp)
  b2:	e8 89 02 00 00       	call   340 <shm_get>
    printf(1, "%d \n", *shared_memory_address4);
  b7:	0f be 00             	movsbl (%eax),%eax
  ba:	83 c4 0c             	add    $0xc,%esp
  bd:	50                   	push   %eax
  be:	68 5d 08 00 00       	push   $0x85d
  c3:	6a 01                	push   $0x1
  c5:	e8 36 04 00 00       	call   500 <printf>
    shared_memory_address4 = shm_get("test2");
  ca:	c7 04 24 62 08 00 00 	movl   $0x862,(%esp)
  d1:	e8 6a 02 00 00       	call   340 <shm_get>
    *shared_memory_address4 = 12;
  d6:	c6 00 0c             	movb   $0xc,(%eax)
    char* shared_memory_address5 = shm_get("test2");
  d9:	c7 04 24 62 08 00 00 	movl   $0x862,(%esp)
  e0:	e8 5b 02 00 00       	call   340 <shm_get>
    printf(1, "%d \n", *shared_memory_address5);
  e5:	83 c4 0c             	add    $0xc,%esp
  e8:	0f be 00             	movsbl (%eax),%eax
  eb:	e9 3b ff ff ff       	jmp    2b <main+0x2b>
 ...
 469:	85 d2                	test   %edx,%edx
{
 ...
 497:	f7 f1                	div    %ecx
 499:	0f b6 92 70 08 00 00 	movzbl 0x870(%edx),%edx
	} while ((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 6b4:	e9 8f fe ff ff       	jmp    548 <printf+0x48>
				if (s == 0) s = "(null)";
 6b9:	bb 68 08 00 00       	mov    $0x868,%ebx
				while (*s != 0) {
 ...
 6d1:	a1 60 0b 00 00       	mov    0xb60,%eax
{
 ...
 70d:	89 08                	mov    %ecx,(%eax)
	freep = p;
 70f:	a3 60 0b 00 00       	mov    %eax,0xb60
}
 714:	5b                   	pop    %ebx
 715:	5e                   	pop    %esi
 716:	5f                   	pop    %edi
 ...
 726:	72 ce                	jb     6f6 <free+0x26>
{
 ...
 747:	03 53 fc             	add    -0x4(%ebx),%edx
	freep = p;
 74a:	a3 60 0b 00 00       	mov    %eax,0xb60
		p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 804:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
 807:	89 15 60 0b 00 00    	mov    %edx,0xb60
}
 ...
 827:	0b 00 00 
 82a:	c7 05 64 0b 00 00 64 	movl   $0xb64,0xb64
 831:	0b 00 00 
		base.s.size                = 0;
 834:	b8 64 0b 00 00       	mov    $0xb64,%eax
 839:	c7 05 68 0b 00 00 00 	movl   $0x0,0xb68
 840:	00 00 00 
