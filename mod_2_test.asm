...
main(void)
{
  ...
  if(fork() == 0)
  11:	e8 c3 02 00 00       	call   2d9 <fork>
  ...
  22:	e8 99 02 00 00       	call   2c0 <shm_get>
      *shared_memory_address1 = 4;
  27:	c6 00 04             	movb   $0x4,(%eax)
      exit();
  2a:	e8 b2 02 00 00       	call   2e1 <exit>
    }

    sleep(10);
  2f:	83 ec 0c             	sub    $0xc,%esp
  32:	6a 0a                	push   $0xa
  34:	e8 38 03 00 00       	call   371 <sleep>
    char* shared_memory_address2 = shm_get("test");
  39:	c7 04 24 98 07 00 00 	movl   $0x798,(%esp)
  40:	e8 7b 02 00 00       	call   2c0 <shm_get>
    printf(1, "%d \n", *shared_memory_address2);
  45:	0f be 00             	movsbl (%eax),%eax
  48:	83 c4 0c             	add    $0xc,%esp
  4b:	50                   	push   %eax
  4c:	68 9d 07 00 00       	push   $0x79d
  51:	6a 01                	push   $0x1
  ...
  // }
    wait();
  58:	e8 8c 02 00 00       	call   2e9 <wait>
    shm_rem("test");
  5d:	c7 04 24 98 07 00 00 	movl   $0x798,(%esp)
  64:	e8 67 02 00 00       	call   2d0 <shm_rem>
   exit();
  69:	e8 73 02 00 00       	call   2e1 <exit>
  6e:	66 90                	xchg   %ax,%ax
 ...
 188:	89 f3                	mov    %esi,%ebx
{
 ...
 1a0:	50                   	push   %eax
 1a1:	6a 00                	push   $0x0
 1a3:	e8 51 01 00 00       	call   2f9 <read>
		if (cc < 1) break;
...
stat(char *n, struct stat *st)
{
 ...
 20d:	e8 0f 01 00 00       	call   321 <open>
	if (fd < 0) return -1;
 ...
 221:	50                   	push   %eax
 222:	e8 12 01 00 00       	call   339 <fstat>
	close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
	r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
	close(fd);
 22c:	e8 d8 00 00 00       	call   309 <close>
	return r;
...
shm_get(char* name)
{
 ...
 2c3:	5d                   	pop    %ebp
	return shmget(name);
 2c4:	e9 b8 00 00 00       	jmp    381 <shmget>
...
shm_rem(char* name)
{
 ...
 2d3:	5d                   	pop    %ebp
	return shmrem(name);
 2d4:	e9 b0 00 00 00       	jmp    389 <shmrem>
 ...
 3a9:	85 d2                	test   %edx,%edx
{
 ...
 3d7:	f7 f1                	div    %ecx
 3d9:	0f b6 92 ac 07 00 00 	movzbl 0x7ac(%edx),%edx
	} while ((x /= base) != 0);
 ...
 410:	e8 ec fe ff ff       	call   301 <write>
...
printf(int fd, char *fmt, ...)
{
 ...
 480:	e8 7c fe ff ff       	call   301 <write>
 ...
 4e1:	e8 1b fe ff ff       	call   301 <write>
 ...
 4f8:	31 ff                	xor    %edi,%edi
	write(fd, &c, 1);
 4fa:	e8 02 fe ff ff       	call   301 <write>
	for (i = 0; fmt[i]; i++) {
 ...
 593:	57                   	push   %edi
 594:	53                   	push   %ebx
 595:	e8 67 fd ff ff       	call   301 <write>
				while (*s != 0) {
 ...
 5e7:	e8 15 fd ff ff       	call   301 <write>
				ap++;
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
				if (s == 0) s = "(null)";
 5f9:	bb a2 07 00 00       	mov    $0x7a2,%ebx
				while (*s != 0) {
...
malloc(uint nbytes)
{
 ...
 6fe:	56                   	push   %esi
 6ff:	e8 65 fc ff ff       	call   369 <sbrk>
