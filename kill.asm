...
shm_get(char* name)
{
 ...
 2b3:	5d                   	pop    %ebp
	return shmget(name);
 2b4:	e9 b8 00 00 00       	jmp    371 <shmget>
...
shm_rem(char* name)
{
 ...
 2c3:	5d                   	pop    %ebp
	return shmrem(name);
 2c4:	e9 b0 00 00 00       	jmp    379 <shmrem>
 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 400:	e8 ec fe ff ff       	call   2f1 <write>
...
printf(int fd, char *fmt, ...)
{
 ...
 470:	e8 7c fe ff ff       	call   2f1 <write>
 ...
 4d1:	e8 1b fe ff ff       	call   2f1 <write>
 ...
 583:	57                   	push   %edi
 584:	53                   	push   %ebx
 585:	e8 67 fd ff ff       	call   2f1 <write>
				while (*s != 0) {
 ...
 5d7:	e8 15 fd ff ff       	call   2f1 <write>
				ap++;
 ...
 601:	a1 90 0a 00 00       	mov    0xa90,%eax
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
	freep = p;
 63f:	a3 90 0a 00 00       	mov    %eax,0xa90
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
	if ((prevp = freep) == 0) {
 69c:	8b 15 90 0a 00 00    	mov    0xa90,%edx
	nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
	return freep;
 70b:	8b 15 90 0a 00 00    	mov    0xa90,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
 737:	89 15 90 0a 00 00    	mov    %edx,0xa90
}
 ...
 757:	0a 00 00 
 75a:	c7 05 94 0a 00 00 94 	movl   $0xa94,0xa94
 761:	0a 00 00 
		base.s.size                = 0;
 764:	b8 94 0a 00 00       	mov    $0xa94,%eax
