...
int mutex_create(char *name){
	return mcreate(name);
  11:	68 78 07 00 00       	push   $0x778
  16:	e8 37 03 00 00       	call   352 <mcreate>
	printf(1,"%d\n", mux_id);
  1b:	83 c4 0c             	add    $0xc,%esp
  1e:	50                   	push   %eax
  1f:	68 7d 07 00 00       	push   $0x77d
  24:	6a 01                	push   $0x1
  26:	e8 f5 03 00 00       	call   420 <printf>
	return mcreate(name);
  2b:	c7 04 24 81 07 00 00 	movl   $0x781,(%esp)
  32:	e8 1b 03 00 00       	call   352 <mcreate>
	printf(1,"%d\n", mux_id);
  37:	83 c4 0c             	add    $0xc,%esp
  3a:	50                   	push   %eax
  3b:	68 7d 07 00 00       	push   $0x77d
  40:	6a 01                	push   $0x1
  42:	e8 d9 03 00 00       	call   420 <printf>
	exit();
  47:	e8 66 02 00 00       	call   2b2 <exit>
  4c:	66 90                	xchg   %ax,%ax
  4e:	66 90                	xchg   %ax,%ax

00000050 <mutex_create>:
int mutex_create(char *name){
  50:	55                   	push   %ebp
  51:	89 e5                	mov    %esp,%ebp
  53:	5d                   	pop    %ebp
	return mcreate(name);
  54:	e9 f9 02 00 00       	jmp    352 <mcreate>
  59:	66 90                	xchg   %ax,%ax
  5b:	66 90                	xchg   %ax,%ax
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3b7:	f7 f1                	div    %ecx
 3b9:	0f b6 92 90 07 00 00 	movzbl 0x790(%edx),%edx
	} while ((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
				if (s == 0) s = "(null)";
 5d9:	bb 86 07 00 00       	mov    $0x786,%ebx
				while (*s != 0) {
 ...
 5f1:	a1 54 0a 00 00       	mov    0xa54,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
	freep = p;
 62f:	a3 54 0a 00 00       	mov    %eax,0xa54
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
	if ((prevp = freep) == 0) {
 68c:	8b 15 54 0a 00 00    	mov    0xa54,%edx
	nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
 727:	89 15 54 0a 00 00    	mov    %edx,0xa54
}
 ...
 747:	0a 00 00 
 74a:	c7 05 58 0a 00 00 58 	movl   $0xa58,0xa58
 751:	0a 00 00 
		base.s.size                = 0;
 754:	b8 58 0a 00 00       	mov    $0xa58,%eax
 759:	c7 05 5c 0a 00 00 00 	movl   $0x0,0xa5c
 760:	00 00 00 
