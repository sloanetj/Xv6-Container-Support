...
int main(){
  ...
  1d:	e8 e0 03 00 00       	call   402 <mcreate>
  22:	83 c4 10             	add    $0x10,%esp
  25:	89 c6                	mov    %eax,%esi
		if (fork() == 0){
  27:	e8 2e 03 00 00       	call   35a <fork>
  2c:	85 c0                	test   %eax,%eax
  2e:	74 1f                	je     4f <main+0x4f>
	for(i=0; i<5; i++){
  ...
  3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
		wait();
  40:	e8 25 03 00 00       	call   36a <wait>
	for(i=0; i<10; i++){
  45:	83 eb 01             	sub    $0x1,%ebx
  48:	75 f6                	jne    40 <main+0x40>
			exit();
  4a:	e8 13 03 00 00       	call   362 <exit>
}
int mutex_lock(int muxid){
	return mlock(muxid);
  4f:	83 ec 0c             	sub    $0xc,%esp
  52:	56                   	push   %esi
  53:	e8 ba 03 00 00       	call   412 <mlock>
			if (!mutex_lock(id)){
  58:	83 c4 10             	add    $0x10,%esp
  5b:	85 c0                	test   %eax,%eax
  5d:	74 61                	je     c0 <main+0xc0>
				printf(1,"%d\n", j);
  5f:	52                   	push   %edx
  60:	6a 01                	push   $0x1
  62:	68 2d 08 00 00       	push   $0x82d
  67:	6a 01                	push   $0x1
  69:	e8 62 04 00 00       	call   4d0 <printf>
  6e:	83 c4 0c             	add    $0xc,%esp
  71:	6a 02                	push   $0x2
  73:	68 2d 08 00 00       	push   $0x82d
  78:	6a 01                	push   $0x1
  7a:	e8 51 04 00 00       	call   4d0 <printf>
  7f:	83 c4 0c             	add    $0xc,%esp
  82:	6a 03                	push   $0x3
  84:	68 2d 08 00 00       	push   $0x82d
  89:	6a 01                	push   $0x1
  8b:	e8 40 04 00 00       	call   4d0 <printf>
			printf(1,"\n");
  90:	59                   	pop    %ecx
  91:	5b                   	pop    %ebx
  92:	68 3f 08 00 00       	push   $0x83f
  97:	6a 01                	push   $0x1
...
int mutex_unlock(int muxid){
  ...
  a1:	e8 74 03 00 00       	call   41a <munlock>
			if (!mutex_unlock(id)){
  a6:	83 c4 10             	add    $0x10,%esp
  a9:	85 c0                	test   %eax,%eax
  ab:	75 9d                	jne    4a <main+0x4a>
				printf(1,"UNLOCK FAILURE\n");
  ad:	50                   	push   %eax
  ae:	50                   	push   %eax
  af:	68 31 08 00 00       	push   $0x831
  b4:	6a 01                	push   $0x1
  b6:	e8 15 04 00 00       	call   4d0 <printf>
  bb:	83 c4 10             	add    $0x10,%esp
  be:	eb 8a                	jmp    4a <main+0x4a>
				printf(1,"LOCK FAILURE\n");
  c0:	56                   	push   %esi
  c1:	56                   	push   %esi
  c2:	68 33 08 00 00       	push   $0x833
  c7:	6a 01                	push   $0x1
  c9:	e8 02 04 00 00       	call   4d0 <printf>
				exit();
  ce:	e8 8f 02 00 00       	call   362 <exit>
  d3:	66 90                	xchg   %ax,%ax
  d5:	66 90                	xchg   %ax,%ax
  d7:	66 90                	xchg   %ax,%ax
  d9:	66 90                	xchg   %ax,%ax
...
int mutex_create(char *name){
  ...
  e3:	5d                   	pop    %ebp
	return mcreate(name);
  e4:	e9 19 03 00 00       	jmp    402 <mcreate>
...
int mutex_lock(int muxid){
  ...
  f3:	5d                   	pop    %ebp
	return mlock(muxid);
  f4:	e9 19 03 00 00       	jmp    412 <mlock>
  f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00000100 <mutex_unlock>:
int mutex_unlock(int muxid){
 100:	55                   	push   %ebp
 101:	89 e5                	mov    %esp,%ebp
 103:	5d                   	pop    %ebp
	return munlock(muxid);
 104:	e9 11 03 00 00       	jmp    41a <munlock>
...
printf(int fd, char *fmt, ...)
{
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
				if (s == 0) s = "(null)";
 689:	bb 41 08 00 00       	mov    $0x841,%ebx
				while (*s != 0) {
...
free(void *ap)
{
 ...
 6a1:	a1 54 0b 00 00       	mov    0xb54,%eax
{
 ...
 6dd:	89 08                	mov    %ecx,(%eax)
	freep = p;
 6df:	a3 54 0b 00 00       	mov    %eax,0xb54
}
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
 ...
 6f6:	72 ce                	jb     6c6 <free+0x26>
{
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
	freep = p;
 71a:	a3 54 0b 00 00       	mov    %eax,0xb54
		p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
	if ((prevp = freep) == 0) {
 73c:	8b 15 54 0b 00 00    	mov    0xb54,%edx
	nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 77f:	73 47                	jae    7c8 <malloc+0x98>
		...
		if (p == freep)
 781:	39 05 54 0b 00 00    	cmp    %eax,0xb54
 ...
 7a6:	e8 f5 fe ff ff       	call   6a0 <free>
	return freep;
 7ab:	8b 15 54 0b 00 00    	mov    0xb54,%edx
 ...
 7d4:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
 7d7:	89 15 54 0b 00 00    	mov    %edx,0xb54
}
 ...
 7e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 54 0b 00 00 58 	movl   $0xb58,0xb54
 7f7:	0b 00 00 
 7fa:	c7 05 58 0b 00 00 58 	movl   $0xb58,0xb58
 801:	0b 00 00 
		base.s.size                = 0;
 804:	b8 58 0b 00 00       	mov    $0xb58,%eax
 809:	c7 05 5c 0b 00 00 00 	movl   $0x0,0xb5c
 810:	00 00 00 
