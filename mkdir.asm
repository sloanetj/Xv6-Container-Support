...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 1f 03 00 00       	call   359 <mkdir>
...
shm_get(char* name)
{
 ...
 2d3:	5d                   	pop    %ebp
	return shmget(name);
 2d4:	e9 b8 00 00 00       	jmp    391 <shmget>
...
shm_rem(char* name)
{
 ...
 2e3:	5d                   	pop    %ebp
	return shmrem(name);
 2e4:	e9 b0 00 00 00       	jmp    399 <shmrem>
 ...
 3b9:	85 d2                	test   %edx,%edx
{
 ...
 420:	e8 ec fe ff ff       	call   311 <write>
...
printf(int fd, char *fmt, ...)
{
 ...
 4f1:	e8 1b fe ff ff       	call   311 <write>
 ...
 508:	31 ff                	xor    %edi,%edi
	write(fd, &c, 1);
 50a:	e8 02 fe ff ff       	call   311 <write>
	for (i = 0; fmt[i]; i++) {
 ...
 5a3:	57                   	push   %edi
 5a4:	53                   	push   %ebx
 5a5:	e8 67 fd ff ff       	call   311 <write>
				while (*s != 0) {
 ...
 5f7:	e8 15 fd ff ff       	call   311 <write>
				ap++;
 ...
 621:	a1 d4 0a 00 00       	mov    0xad4,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
	freep = p;
 65f:	a3 d4 0a 00 00       	mov    %eax,0xad4
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
	freep = p;
 69a:	a3 d4 0a 00 00       	mov    %eax,0xad4
		p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
	if ((prevp = freep) == 0) {
 6bc:	8b 15 d4 0a 00 00    	mov    0xad4,%edx
	nunits = (nbytes + sizeof(Header) - 1) / sizeof(Header) + 1;
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
	return freep;
 72b:	8b 15 d4 0a 00 00    	mov    0xad4,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
			freep = prevp;
 757:	89 15 d4 0a 00 00    	mov    %edx,0xad4
}
 ...
 769:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
		base.s.ptr = freep = prevp = &base;
 770:	c7 05 d4 0a 00 00 d8 	movl   $0xad8,0xad4
 777:	0a 00 00 
 77a:	c7 05 d8 0a 00 00 d8 	movl   $0xad8,0xad8
 781:	0a 00 00 
		base.s.size                = 0;
 784:	b8 d8 0a 00 00       	mov    $0xad8,%eax
 789:	c7 05 dc 0a 00 00 00 	movl   $0x0,0xadc
 790:	00 00 00 
